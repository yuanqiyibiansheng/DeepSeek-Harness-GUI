  ...
  return {
    ...
    host: {
      ...
      async readInstructions(request) {
        return { rpcId: request.rpcId, result: { ok: true, value: { content: null } } }
      },
    ...
    skills: {
      ...
      async updateManaged(request) {
        return {
          ...
          result: {
            ok: true,
            value: { name: request.payload.name, description: '', modelInvocable: true, userInvocable: true, path: '', loadable: true },
          },
        }
      },
    ...
    pluginMarket: {
      async snapshot(request) {
        return { rpcId: request.rpcId, result: { ok: true, value: { market: [], installed: [] } } }
      },
      async install(request) {
        return { rpcId: request.rpcId, result: { ok: true, value: { installed: true as const } } }
      },
      async uninstall(request) {
        return { rpcId: request.rpcId, result: { ok: true, value: { removed: true as const } } }
      },
      async update(request) {
        return { rpcId: request.rpcId, result: { ok: true, value: { updated: true as const } } }
      },
    },
  }
}

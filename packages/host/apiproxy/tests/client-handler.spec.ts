...
function scriptedApi(overrides: {
  ...
  return {
    ...
    host: {
      ...
      readInstructions: r => ok(r, { content: null }),
      writeInstructions: r => ok(r, { written: true as const }),
      ...overrides.host,
    },
    workspace: {
    ...
    skills: {
      ...
      updateManaged: r => ok(r, {
        name: r.payload.name, description: '', modelInvocable: true, userInvocable: true, path: '', loadable: true,
      }),
      removeManaged: r => ok(r, { removed: true }),
      ...overrides.skills,
    },
    agentPresets: {
    ...
    pluginMarket: {
      snapshot: r => ok(r, { market: [], installed: [] }),
      install: r => ok(r, { installed: true as const }),
      uninstall: r => ok(r, { removed: true as const }),
      update: r => ok(r, { updated: true as const }),
      ...overrides.pluginMarket,
    },
  }
}

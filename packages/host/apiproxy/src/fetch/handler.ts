...
import {
  ...
  hostPickDirectoryRequestSchema, hostReadInstructionsRequestSchema, hostWriteInstructionsRequestSchema,
...
import {
  skillListManagedRequestSchema, skillListRequestSchema, skillRemoveManagedRequestSchema,
  skillUpdateManagedRequestSchema,
} from '../api/skills.schema.ts'
import {
  pluginMarketInstallRequestSchema, pluginMarketSnapshotRequestSchema,
  pluginMarketUninstallRequestSchema, pluginMarketUpdateRequestSchema,
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'host.readInstructions': { schema: hostReadInstructionsRequestSchema, invoke: (api, r, signal) => api.host.readInstructions(r, signal) },
  'host.writeInstructions': { schema: hostWriteInstructionsRequestSchema, invoke: (api, r, signal) => api.host.writeInstructions(r, signal) },
  ...
  'skill.updateManaged': { schema: skillUpdateManagedRequestSchema, invoke: (api, r) => api.skills.updateManaged(r) },
  'skill.removeManaged': { schema: skillRemoveManagedRequestSchema, invoke: (api, r) => api.skills.removeManaged(r) },
  'pluginMarket.snapshot': { schema: pluginMarketSnapshotRequestSchema, invoke: (api, r) => api.pluginMarket.snapshot(r) },
  'pluginMarket.install': { schema: pluginMarketInstallRequestSchema, invoke: (api, r) => api.pluginMarket.install(r) },
  'pluginMarket.uninstall': { schema: pluginMarketUninstallRequestSchema, invoke: (api, r) => api.pluginMarket.uninstall(r) },
  'pluginMarket.update': { schema: pluginMarketUpdateRequestSchema, invoke: (api, r) => api.pluginMarket.update(r) },

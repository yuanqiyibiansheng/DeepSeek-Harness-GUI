...
import {
  ...
  hostReadInstructionsValueSchema, hostWriteInstructionsValueSchema,
...
import {
  skillListManagedValueSchema, skillListValueSchema, skillRemoveManagedValueSchema,
  skillUpdateManagedValueSchema,
} from '../api/skills.schema.ts'
import {
  pluginMarketInstallValueSchema, pluginMarketSnapshotValueSchema,
  pluginMarketUninstallValueSchema, pluginMarketUpdateValueSchema,
} from '../api/plugin-market.schema.ts'
import {
...
export interface IApiClient {
  ...
  host: {
    ...
    readInstructions(payload: RequestPayload<'host.readInstructions'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'host.readInstructions'>>>
    writeInstructions(payload: RequestPayload<'host.writeInstructions'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'host.writeInstructions'>>>
  }
  workspace: {
  ...
  skills: {
    ...
    updateManaged(payload: RequestPayload<'skill.updateManaged'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'skill.updateManaged'>>>
    removeManaged(payload: RequestPayload<'skill.removeManaged'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'skill.removeManaged'>>>
  }
  pluginMarket: {
    snapshot(payload: RequestPayload<'pluginMarket.snapshot'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'pluginMarket.snapshot'>>>
    install(payload: RequestPayload<'pluginMarket.install'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'pluginMarket.install'>>>
    uninstall(payload: RequestPayload<'pluginMarket.uninstall'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'pluginMarket.uninstall'>>>
    update(payload: RequestPayload<'pluginMarket.update'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'pluginMarket.update'>>>
  }
  agentPresets: {
...
const UNARY_VALUE_SCHEMAS: { [K in keyof RpcMethodMap]: z.ZodType<Wire<ResponseValue<K>>> } = {
  ...
  'host.readInstructions': hostReadInstructionsValueSchema,
  'host.writeInstructions': hostWriteInstructionsValueSchema,
  ...
  'skill.updateManaged': skillUpdateManagedValueSchema,
  'skill.removeManaged': skillRemoveManagedValueSchema,
  'pluginMarket.snapshot': pluginMarketSnapshotValueSchema,
  'pluginMarket.install': pluginMarketInstallValueSchema,
  'pluginMarket.uninstall': pluginMarketUninstallValueSchema,
  'pluginMarket.update': pluginMarketUpdateValueSchema,
...
export abstract class AbstractApiClient implements IApiClient {
  ...
  readonly host: IApiClient['host'] = {
    ...
    readInstructions: (payload, signal) => this.callUnary('host.readInstructions', payload, signal),
    writeInstructions: (payload, signal) => this.callUnary('host.writeInstructions', payload, signal),
  }
  ...
  readonly skills: IApiClient['skills'] = {
    ...
    updateManaged: (payload, signal) => this.callUnary('skill.updateManaged', payload, signal),
    removeManaged: (payload, signal) => this.callUnary('skill.removeManaged', payload, signal),
  }

  readonly pluginMarket: IApiClient['pluginMarket'] = {
    snapshot: (payload, signal) => this.callUnary('pluginMarket.snapshot', payload, signal),
    install: (payload, signal) => this.callUnary('pluginMarket.install', payload, signal),
    uninstall: (payload, signal) => this.callUnary('pluginMarket.uninstall', payload, signal),
    update: (payload, signal) => this.callUnary('pluginMarket.update', payload, signal),
  }

...
import type { PluginMarketApi } from './plugin-market.ts'
...
export interface RpcMethodMap {
  ...
  'host.readInstructions': HostApi['readInstructions']
  'host.writeInstructions': HostApi['writeInstructions']
  ...
  'skill.updateManaged': SkillsApi['updateManaged']
  'skill.removeManaged': SkillsApi['removeManaged']
  'pluginMarket.snapshot': PluginMarketApi['snapshot']
  'pluginMarket.install': PluginMarketApi['install']
  'pluginMarket.uninstall': PluginMarketApi['uninstall']
  'pluginMarket.update': PluginMarketApi['update']

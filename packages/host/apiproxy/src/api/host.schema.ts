...
/** host.readInstructions request payload (empty object literal). */
export const hostReadInstructionsRequestSchema = z.object({}) satisfies z.ZodType<Wire<RequestPayload<'host.readInstructions'>>>

/** host.readInstructions response value; null when the file does not exist yet. */
export const hostReadInstructionsValueSchema = z.object({
  content: z.string().nullable(),
}) satisfies z.ZodType<Wire<ResponseValue<'host.readInstructions'>>>

/** host.writeInstructions request payload. */
export const hostWriteInstructionsRequestSchema = z.object({
  content: z.string(),
}) satisfies z.ZodType<Wire<RequestPayload<'host.writeInstructions'>>>

/** host.writeInstructions response value. */
export const hostWriteInstructionsValueSchema = z.object({
  written: z.literal(true),
}) satisfies z.ZodType<Wire<ResponseValue<'host.writeInstructions'>>>

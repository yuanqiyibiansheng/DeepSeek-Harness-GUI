...
export class FakeApiClient implements IApiClient {
  ...
  readonly host: IApiClient['host'] = {
    ...
    readInstructions: payload => this.record('host.readInstructions', payload, Promise.resolve(ok({ content: null }))),
    writeInstructions: payload => this.record('host.writeInstructions', payload, Promise.resolve(ok({ written: true }))),
  }

...
import sessionRewindRemote from '@deepseek-ai/dsh-session-rewind/remote'
...
export type {} from '@deepseek-ai/dsh-session-rewind/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, sessionRewindRemote, dynamicRemote, pluginInventoryRemote, messageFeedbackRemote,
    ]) {

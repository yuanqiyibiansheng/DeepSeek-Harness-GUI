window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region lib/types/client/market-data.js
		/**
		...
		*/
		...
		//#endregion
		//#region lib/types/client/InstallToast.js
		/**
		...
		*/
		function InstallToast(props) {
			...
			return (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Toast, {
				...
				icon: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconSparkle16, { size: 14 }),
				onDone: () => setNames([])
			});
		}
		//#endregion
		//#region \0dsh-css:H:\123pan\Downloads\deepseek-harness-master\packages\bundle\dsh-market\src\client\Market.module.css.mjs
		const css = ".lfVxGa_root{min-width:0;height:100%;color:var(--dsw-alias-label-primary,#1f2328);flex-direction:column;display:flex;position:relative}.lfVxGa_head{flex-direction:column;gap:12px;padding:4px 4px 6px;display:flex}.lfVxGa_title{margin:0;font-size:16px;font-weight:500;line-height:24px}.lfVxGa_sub{color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;gap:8px;margin:0;font-size:12px;line-height:18px;display:flex}.lfVxGa_submitLink{color:var(--dsw-alias-label-tertiary,#8b93a1);white-space:nowrap;font-size:11px;line-height:18px;text-decoration:none}.lfVxGa_submitLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.lfVxGa_tabs{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:flex-end;gap:2px;display:flex}.lfVxGa_tab{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-bottom:2px solid #0000;padding:7px 12px;font-size:13px}.lfVxGa_tab.lfVxGa_on{color:var(--dsw-alias-brand-primary,#4f6ef7);border-bottom-color:var(--dsw-alias-brand-primary,#4f6ef7);font-weight:600}.lfVxGa_subTabs{align-items:flex-end;gap:2px;margin:-4px 0 4px;display:flex}.lfVxGa_banner{background:var(--dsw-alias-bg-layer-2,#fdf3e3);border:1px solid var(--dsw-alias-border-l2,#f3e3c3);border-radius:8px;align-items:center;gap:8px;margin:0;padding:8px 12px;font-size:12px;display:flex}.lfVxGa_bannerIcon{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0}.lfVxGa_bannerHint{color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:help;display:inline-flex}.lfVxGa_body{flex:1;padding:12px 4px 24px;overflow:hidden auto}.lfVxGa_stickyHead{z-index:5;background:var(--dsw-alias-bg-layer-2,#f7f8fa);position:sticky;top:-1px}.lfVxGa_stickyHead:before{content:\"\";background:inherit;pointer-events:none;height:14px;position:absolute;bottom:100%;left:0;right:0}.lfVxGa_cats{margin:0 -4px 2px;padding:12px 4px 4px}.lfVxGa_catsRow{align-items:flex-start;gap:8px;display:flex;position:relative}.lfVxGa_star{color:var(--dsw-alias-label-secondary,#9ca3af);white-space:nowrap;flex:none;font-size:11px}.lfVxGa_top{z-index:20;display:inline-flex;position:absolute;bottom:18px;right:18px}.lfVxGa_topBtn{border-radius:99px;width:38px;height:38px;padding:0}.lfVxGa_tag{border:1px solid var(--dsw-alias-border-l3,#d9dde3);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:4px;flex-shrink:0;padding:1px 6px;font-size:11px;line-height:16px}.lfVxGa_okState{color:var(--dsw-alias-state-success-primary,#16a34a);white-space:nowrap;font-size:12px;font-weight:600}.lfVxGa_catsWrap{flex-wrap:wrap;flex:1;align-items:center;gap:6px;min-width:0;display:flex}.lfVxGa_catsCollapsed{max-height:62px;overflow:hidden}.lfVxGa_catsToggle.lfVxGa_catsToggle{height:26px;min-height:26px;color:var(--dsw-alias-label-secondary,#6b7280);padding:0 6px}.lfVxGa_shots{-webkit-overflow-scrolling:touch;scrollbar-width:thin;gap:8px;margin:6px 0 8px;padding:2px 0 6px;display:flex;overflow-x:auto}.lfVxGa_shot{object-fit:cover;border:1px solid var(--dsw-alias-border-default,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);cursor:pointer;border-radius:8px;flex:none;width:220px;height:150px}.lfVxGa_cardShots{-webkit-overflow-scrolling:touch;scrollbar-width:thin;gap:6px;margin:0 0 6px;padding:0 0 2px;display:flex;overflow-x:auto}.lfVxGa_cardShot{object-fit:contain;border:1px solid var(--dsw-alias-border-default,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);cursor:pointer;border-radius:8px;flex:none;width:132px;height:88px;display:block}.lfVxGa_lightbox{z-index:10000;cursor:zoom-out;background:#000000d9;justify-content:center;align-items:center;display:flex;position:fixed;inset:0}.lfVxGa_lightboxImg{object-fit:contain;cursor:default;border-radius:4px;max-width:90vw;max-height:85vh}.lfVxGa_lightboxClose{color:#fff;cursor:pointer;background:#ffffff1f;border:none;border-radius:99px;place-items:center;width:36px;height:36px;font-size:22px;line-height:1;display:grid;position:absolute;top:16px;right:16px}.lfVxGa_lightboxClose:hover{background:#ffffff38}.lfVxGa_lightboxNav{color:#fff;cursor:pointer;background:#ffffff1f;border:none;border-radius:99px;place-items:center;width:44px;height:44px;display:grid;position:absolute;top:50%;transform:translateY(-50%)}.lfVxGa_lightboxNav:hover{background:#ffffff38}.lfVxGa_lightboxPrev{left:16px}.lfVxGa_lightboxNext{right:16px}.lfVxGa_lightboxDots{gap:8px;display:flex;position:absolute;bottom:20px;left:50%;transform:translate(-50%)}.lfVxGa_lightboxDot{cursor:pointer;background:#fff6;border-radius:99px;width:7px;height:7px}.lfVxGa_lightboxDotOn{background:#fff}.lfVxGa_cmd{background:var(--dsw-alias-bg-layer-2,#f3f4f6);word-break:break-all;border-radius:6px;margin:8px 0 0;padding:8px 10px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:18px}.lfVxGa_warnLine{color:var(--dsw-alias-state-warn-primary,#b45309);flex-wrap:wrap;align-items:center;gap:4px;margin:0;font-size:12px;font-weight:600;line-height:18px;display:flex}.lfVxGa_modalNote{color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;gap:4px;margin:12px 0 0;font-size:12px;line-height:18px;display:flex}.lfVxGa_grid{grid-template-columns:repeat(2,minmax(0,1fr));align-items:start;gap:10px;display:grid}.lfVxGa_masonry{align-items:flex-start;gap:10px;display:flex}.lfVxGa_masonryCol{flex-direction:column;flex:1;gap:10px;min-width:0;display:flex}.lfVxGa_masonry>.lfVxGa_masonryCol>*{align-self:stretch;min-width:0}@media (width<=680px){.lfVxGa_masonry{flex-direction:column}}.lfVxGa_pairGrid{grid-template-columns:repeat(2,minmax(0,1fr));align-items:start;gap:10px;display:grid}@media (width<=680px){.lfVxGa_grid,.lfVxGa_pairGrid{grid-template-columns:minmax(0,1fr)}}.lfVxGa_swatches{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;gap:0;height:34px;display:flex;overflow:hidden}.lfVxGa_themesGrid{margin-bottom:12px}.lfVxGa_swatches i{flex:1}.lfVxGa_card{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;align-self:start;gap:12px;padding:12px 14px;display:flex}.lfVxGa_row1{align-items:flex-start;gap:10px;min-width:0;display:flex}.lfVxGa_cardAction{flex-shrink:0;align-items:center;display:inline-flex}.lfVxGa_installBtn.lfVxGa_installBtn{min-width:64px}.lfVxGa_av{color:#fff;object-fit:cover;background:var(--dsw-alias-bg-layer-2,#f3f4f6);border-radius:50%;flex-shrink:0;place-items:center;width:16px;height:16px;font-size:9px;font-weight:700;display:grid}.lfVxGa_nm{text-overflow:ellipsis;white-space:nowrap;font-size:15px;font-weight:600;line-height:22px;overflow:hidden}.lfVxGa_nmLink{color:inherit;text-decoration:none;display:block}.lfVxGa_nmLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.lfVxGa_byline{flex-wrap:wrap;align-items:center;gap:6px;min-width:0;margin-top:2px;display:flex}.lfVxGa_meta{color:var(--dsw-alias-label-secondary,#9ca3af);margin-top:2px;font-size:11px}.lfVxGa_metaInline{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px}.lfVxGa_owner{color:var(--dsw-alias-label-secondary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;flex:0 auto;min-width:44px;font-size:11px;overflow:hidden}.lfVxGa_desc{color:var(--dsw-alias-label-tertiary,#8b93a1);margin:0;font-size:12px;line-height:18px}.lfVxGa_descClamp{-webkit-line-clamp:5;-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}.lfVxGa_descToggle{width:20px;height:16px;color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:pointer;background:0 0;border:none;justify-content:center;align-items:center;margin-top:2px;padding:0;display:flex}.lfVxGa_descToggle:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.lfVxGa_foot{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.lfVxGa_foot .lfVxGa_metaInline,.lfVxGa_foot .lfVxGa_src{white-space:nowrap}.lfVxGa_grow{flex:1}.lfVxGa_titleRow{align-items:center;gap:10px;display:flex}.lfVxGa_version{color:var(--dsw-alias-label-tertiary,#8b93a1);font-variant-numeric:tabular-nums;flex-shrink:0;font-size:12px;line-height:20px}.lfVxGa_repoLink{color:var(--dsw-alias-label-tertiary,#8b93a1);flex-shrink:0;font-size:12px;line-height:20px;text-decoration:none}.lfVxGa_repoLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.lfVxGa_descTight{min-height:0}.lfVxGa_src{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px;text-decoration:none}.lfVxGa_src:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.lfVxGa_dot{vertical-align:2px;margin-left:5px}.lfVxGa_act{flex-wrap:wrap;align-items:center;gap:6px;margin-top:6px;font-size:11px;display:flex}.lfVxGa_actLive{color:var(--dsw-alias-state-success-primary,#16a34a);align-items:center;gap:4px;font-weight:600;display:inline-flex}.lfVxGa_actWarn{color:var(--dsw-alias-state-warn-primary,#b45309);align-items:center;gap:4px;font-weight:600;display:inline-flex}.lfVxGa_actBroken{color:var(--dsw-alias-state-error-primary,#dc2626);align-items:center;gap:4px;font-weight:600;display:inline-flex}.lfVxGa_actWhy{color:var(--dsw-alias-label-secondary,#6b7280);margin-top:2px}.lfVxGa_loading{color:var(--dsw-alias-label-secondary,#9ca3af);flex-direction:column;align-items:center;gap:12px;padding:48px;font-size:13px;display:flex}.lfVxGa_spin{color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;animation:.8s linear infinite lfVxGa_sp;display:inline-flex}.lfVxGa_logoMark{color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;display:inline-flex}.lfVxGa_logoPlug{transform-box:fill-box;transform-origin:50%;animation:1.5s cubic-bezier(.4,0,.2,1) infinite lfVxGa_dshmPlug}@keyframes lfVxGa_dshmPlug{0%,12%{transform:rotate(9deg)}45%,62%{transform:translate(-1.28px,1.27px)rotate(0)}95%,to{transform:rotate(9deg)}}@media (prefers-reduced-motion:reduce){.lfVxGa_logoPlug,.lfVxGa_spin{animation:1.5s ease-in-out infinite lfVxGa_dshmPlugFade}}@keyframes lfVxGa_dshmPlugFade{0%,to{opacity:1}50%{opacity:.35}}@keyframes lfVxGa_sp{to{transform:rotate(360deg)}}.lfVxGa_progress{background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:8px;flex-wrap:wrap;align-items:center;gap:9px;margin:0;padding:8px 12px;font-size:12px;display:flex}.lfVxGa_bar{background:var(--dsw-alias-border-l1,#e5e7eb);border-radius:99px;width:100%;height:4px;overflow:hidden}.lfVxGa_barFill{background:var(--dsw-alias-brand-primary,#4f6ef7);border-radius:99px;height:100%;transition:width .6s}.lfVxGa_barWave{width:30%;animation:1.2s ease-in-out infinite lfVxGa_dshmSlide}@keyframes lfVxGa_dshmSlide{0%{margin-left:-30%}to{margin-left:100%}}.lfVxGa_irow .lfVxGa_progress{margin-top:8px}.lfVxGa_progress code{text-overflow:ellipsis;white-space:nowrap;font-family:ui-monospace,Menlo,monospace;font-size:11px;overflow:hidden}.lfVxGa_empty{color:var(--dsw-alias-label-secondary,#9ca3af);text-align:center;padding:32px;font-size:13px}.lfVxGa_err{color:var(--dsw-alias-state-error-primary,#dc2626);white-space:pre-wrap;word-break:break-all;margin:8px 0;font-size:12px}.lfVxGa_cardBlocked{border-color:var(--dsw-alias-state-error-primary,#dc2626)}.lfVxGa_conflictHead{align-items:flex-start;gap:8px;display:flex}.lfVxGa_conflictIcon{color:var(--dsw-alias-state-error-primary,#dc2626);flex-shrink:0;margin-top:1px}.lfVxGa_conflictTitle{color:var(--dsw-alias-state-error-primary,#dc2626);font-size:13px;font-weight:600;line-height:18px}.lfVxGa_conflictBody{margin:0;font-size:12px;line-height:19px}.lfVxGa_roster{background:var(--dsw-alias-border-l2,#e5e7eb);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;flex-direction:column;gap:1px;display:flex;overflow:hidden}.lfVxGa_rosterRow{background:var(--dsw-alias-bg-layer-1,#fff);align-items:center;gap:8px;padding:7px 10px;display:flex}.lfVxGa_rosterMain{flex-direction:column;min-width:0;display:flex}.lfVxGa_rosterName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:12px;font-weight:600;overflow:hidden}.lfVxGa_rosterAuthor{color:var(--dsw-alias-label-secondary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;font-size:10.5px;overflow:hidden}.lfVxGa_rosterTag{border-radius:4px;flex-shrink:0;margin-left:auto;padding:1px 6px;font-size:10.5px;font-weight:600}.lfVxGa_rosterTagKeep{color:var(--dsw-alias-state-success-primary,#16a34a);background:#16a34a1f}.lfVxGa_rosterTagDrop{color:var(--dsw-alias-state-error-primary,#dc2626);background:#dc26261f}.lfVxGa_rosterRowOut .lfVxGa_rosterName{text-decoration:line-through}.lfVxGa_rosterRowOut{opacity:.62}.lfVxGa_rosterSplit{background:var(--dsw-alias-border-l2,#e5e7eb);height:1px}.lfVxGa_reassure{color:var(--dsw-alias-label-secondary,#6b7280);align-items:center;gap:5px;margin:0;font-size:11.5px;line-height:17px;display:flex}.lfVxGa_reassureOk{color:var(--dsw-alias-state-success-primary,#16a34a);flex-shrink:0}.lfVxGa_conflictWhy{color:var(--dsw-alias-label-tertiary,#8b93a1);overflow-wrap:anywhere;margin-top:2px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:17px}.lfVxGa_conflictWhyText{margin-top:5px;font-family:-apple-system,BlinkMacSystemFont,PingFang SC,sans-serif}.lfVxGa_choices{flex-direction:column;gap:7px;display:flex}.lfVxGa_choice{text-align:left;font:inherit;cursor:pointer;background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:9px;align-items:flex-start;gap:9px;padding:9px 11px;display:flex}.lfVxGa_choice:has(input:disabled){cursor:default;opacity:.6}.lfVxGa_choiceOn{border-color:var(--dsw-alias-brand-primary,#4f6ef7);background:var(--dsw-alias-bg-layer-2,#f5f7ff)}.lfVxGa_choiceRadio{width:13px;height:13px;accent-color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;margin:2px 0 0}.lfVxGa_choiceMain{flex-direction:column;gap:3px;min-width:0;display:flex}.lfVxGa_choiceTitle{font-size:12px;font-weight:600;line-height:17px}.lfVxGa_choiceNote{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:11px;line-height:16px}.lfVxGa_choiceSafe{color:var(--dsw-alias-state-success-primary,#16a34a)}.lfVxGa_stateTag{white-space:nowrap;background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-height:20px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:5px;flex-shrink:0;align-items:center;gap:5px;padding:1px 7px;font-size:11px;line-height:16px;display:inline-flex}.lfVxGa_stateTag[data-on=true]{color:var(--dsw-alias-state-success-primary,#16a34a);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#16a34a) 10%, transparent)}.lfVxGa_stateDot{background:var(--dsw-alias-label-tertiary,#8b93a1);border-radius:999px;flex:none;width:6px;height:6px}.lfVxGa_stateDot[data-on=true]{background:var(--dsw-alias-state-success-primary,#16a34a)}.lfVxGa_metaTag{text-overflow:ellipsis;white-space:nowrap;background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-width:0;max-width:100%;min-height:20px;color:var(--dsw-alias-label-tertiary,#8b93a1);border-radius:5px;flex-shrink:1;padding:1px 7px;font-size:11px;line-height:18px;display:inline-block;overflow:hidden}.lfVxGa_metaTagOk{color:var(--dsw-alias-state-success-primary,#16a34a);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#16a34a) 10%, transparent)}.lfVxGa_nameLink{color:inherit;text-decoration:none}.lfVxGa_nameLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.lfVxGa_opWrap{flex-shrink:0;display:inline-flex;position:relative}.lfVxGa_opEntry{font:inherit;cursor:pointer;white-space:nowrap;color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:7px;align-items:center;gap:6px;padding:4px 10px;font-size:12px;display:inline-flex;position:relative}.lfVxGa_opEntryQuiet{color:var(--dsw-alias-label-secondary,#6b7280);background:0 0;border-color:#0000}.lfVxGa_opEntryAlert{border-color:var(--dsw-alias-state-error-primary,#dc2626);color:var(--dsw-alias-state-error-primary,#dc2626)}.lfVxGa_opDot{background:var(--dsw-alias-state-error-primary,#dc2626);border-radius:99px;width:8px;height:8px;position:absolute;top:-3px;right:-3px}.lfVxGa_opPanel{z-index:40;background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:12px;width:460px;max-width:86vw;max-height:70vh;position:absolute;top:calc(100% + 6px);right:0;overflow-y:auto;box-shadow:0 20px 52px #00000047}.lfVxGa_opHead{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:center;gap:8px;padding:9px 14px;display:flex}.lfVxGa_opPanelTitle{font-size:12.5px;font-weight:600}.lfVxGa_opCloseBtn.lfVxGa_opCloseBtn{min-width:0;color:var(--dsw-alias-label-secondary,#6b7280);padding:0 6px}.lfVxGa_opAggregate{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f7f8fa);padding:9px 14px}.lfVxGa_opAggregateTop{font-variant-numeric:tabular-nums;font-size:12px;font-weight:600}.lfVxGa_opAggregateHint{color:var(--dsw-alias-label-tertiary,#8b93a1);margin-top:4px;font-size:10.5px}.lfVxGa_opRow{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:flex-start;gap:9px;padding:9px 14px;display:flex}.lfVxGa_opRow:last-child{border-bottom:none}.lfVxGa_opRowAlert{background:#dc26260f}.lfVxGa_opIcon{flex-shrink:0;place-items:center;width:14px;margin-top:1px;display:grid}.lfVxGa_opQueuedIcon{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:12px}.lfVxGa_opMain{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.lfVxGa_opTop{align-items:baseline;gap:6px;min-width:0;display:flex}.lfVxGa_opVerb{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;font-size:12px}.lfVxGa_opName{text-overflow:ellipsis;white-space:nowrap;font-size:12px;font-weight:600;overflow:hidden}.lfVxGa_opStatus{color:var(--dsw-alias-label-tertiary,#8b93a1);overflow-wrap:anywhere;font-size:10.5px;line-height:16px}.lfVxGa_opStatusBad{color:var(--dsw-alias-state-error-primary,#dc2626)}.lfVxGa_opActions{flex-shrink:0;align-items:center;gap:6px;margin-top:1px;display:flex}.lfVxGa_opDecision{border-top:1px dashed var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:8px;margin-top:8px;padding-top:8px;display:flex}.lfVxGa_opDecisionFoot{align-items:center;gap:8px;display:flex}.lfVxGa_conflictDetailsToggle{font:inherit;cursor:pointer;color:var(--dsw-alias-label-tertiary,#8b93a1);background:0 0;border:none;align-items:center;gap:4px;padding:2px 0;font-size:11px;display:inline-flex}.lfVxGa_conflictDetailsToggle:hover{color:var(--dsw-alias-label-secondary,#6b7280)}.lfVxGa_opEmpty{text-align:center;color:var(--dsw-alias-label-secondary,#6b7280);padding:30px 14px;font-size:12px}.lfVxGa_opEmptyHint{color:var(--dsw-alias-label-tertiary,#8b93a1);margin-top:4px;font-size:11px}.lfVxGa_cardBlockedMark{font:inherit;cursor:pointer;color:var(--dsw-alias-state-error-primary,#dc2626);border:1px solid var(--dsw-alias-state-error-primary,#dc2626);background:#dc262614;border-radius:7px;align-items:center;gap:5px;padding:4px 9px;font-size:11px;display:inline-flex}.lfVxGa_dangerBtn.lfVxGa_dangerBtn{color:var(--dsw-alias-state-error-primary,#dc2626);border-color:var(--dsw-alias-state-error-primary,#dc2626)}.lfVxGa_dangerBtn.lfVxGa_dangerBtn:hover:not(:disabled){background:var(--dsw-alias-state-error-primary,#dc2626);color:#fff}.lfVxGa_dangerArmed.lfVxGa_dangerArmed{background:var(--dsw-alias-state-error-primary,#dc2626);border-color:var(--dsw-alias-state-error-primary,#dc2626);color:#fff}.lfVxGa_retryBtn{margin-top:4px}.lfVxGa_irow{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:10px;flex-direction:column;gap:10px;min-width:0;padding:12px 14px;display:flex}.lfVxGa_irowActions{flex-wrap:wrap;justify-content:flex-start;align-items:center;gap:8px;min-width:0;display:flex}.lfVxGa_irowTrailing{flex-wrap:nowrap;align-items:center;gap:8px;min-width:0;display:inline-flex}.lfVxGa_irowMissing{filter:grayscale();opacity:.5}.lfVxGa_irow>.lfVxGa_src,.lfVxGa_irow>.lfVxGa_owner,.lfVxGa_irow button{white-space:nowrap;flex-shrink:0}.lfVxGa_tabSearchRow{padding:0 4px 6px;display:flex}.lfVxGa_tabSearch{width:100%}.lfVxGa_spec{color:var(--dsw-alias-label-secondary,#9ca3af);overflow-wrap:anywhere;min-width:0;font-family:ui-monospace,Menlo,monospace;font-size:11px}.lfVxGa_specTag{white-space:nowrap;border-radius:4px;flex-shrink:0;align-items:center;height:16px;padding:0 5px;font-size:10px;font-weight:600;display:inline-flex}.lfVxGa_specTagGit{color:#0b7285;background:#12a3c41f}.lfVxGa_specTagFile{color:#b07d1b;background:#f0b42924}.lfVxGa_backupCheckList .lfVxGa_grow{white-space:nowrap;text-overflow:ellipsis;flex:70%;min-width:0;overflow:hidden}.lfVxGa_backupCheckList .lfVxGa_spec{text-align:right;white-space:nowrap;text-overflow:ellipsis;flex:0 30%;max-width:30%;overflow:hidden}.lfVxGa_staleAction{margin-top:8px}.lfVxGa_pct{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;font-size:11px;font-weight:600}.lfVxGa_pager{flex-wrap:wrap;justify-content:space-between;align-items:center;gap:12px;margin:16px 0 4px;display:flex}.lfVxGa_pagerPages{flex-wrap:wrap;flex:1;justify-content:center;align-items:center;gap:6px;min-width:0;display:flex}.lfVxGa_pageEllipsis{color:var(--dsw-alias-label-secondary,#9ca3af);padding:0 2px;font-size:12px}.lfVxGa_pageInfo{color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;font-size:12px}.lfVxGa_depBadge{border:1px solid var(--dsw-alias-state-warn-primary,#b45309);color:var(--dsw-alias-state-warn-primary,#b45309);white-space:nowrap;border-radius:4px;flex-shrink:0;margin-left:6px;padding:1px 6px;font-size:11px;font-weight:600;line-height:16px}.lfVxGa_deprecate{color:var(--dsw-alias-state-warn-primary,#b45309);background:var(--dsw-alias-bg-layer-2,#fdf3e3);border:1px solid var(--dsw-alias-border-l2,#f3e3c3);border-radius:8px;margin:0;padding:8px 10px;font-size:12px;line-height:18px}.lfVxGa_deprecate a{color:var(--dsw-alias-state-warn-primary,#b45309);text-decoration:underline}.lfVxGa_deprecate .lfVxGa_src{margin-left:8px}.lfVxGa_depLine{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.lfVxGa_switch{border:1px solid var(--dsw-alias-border-l2,#d9dde3);background:var(--dsw-alias-bg-layer-2,#e5e7eb);cursor:pointer;border-radius:99px;flex-shrink:0;width:38px;height:22px;padding:0;transition:background .15s,border-color .15s;position:relative}.lfVxGa_switchOn{background:var(--dsw-alias-state-success-primary,#16a34a);border-color:var(--dsw-alias-state-success-primary,#16a34a)}.lfVxGa_switchMixed{background:var(--dsw-alias-state-warn-primary,#b45309);border-color:var(--dsw-alias-state-warn-primary,#b45309)}.lfVxGa_switchKnob{background:#fff;border-radius:99px;width:16px;height:16px;transition:left .15s;position:absolute;top:2px;left:2px;box-shadow:0 1px 2px #00000040}.lfVxGa_switchOn .lfVxGa_switchKnob,.lfVxGa_switchMixed .lfVxGa_switchKnob{left:18px}.lfVxGa_switch:disabled{opacity:.5;cursor:default}.lfVxGa_viewBar{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;align-items:center;gap:2px;width:fit-content;margin-bottom:12px;padding:2px;display:flex}.lfVxGa_viewBtn{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-radius:6px;padding:4px 10px;font-size:12px;line-height:18px}.lfVxGa_viewBtn:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.lfVxGa_viewOn{background:var(--dsw-alias-bg-layer-2,#eef0f4);color:var(--dsw-alias-label-primary,#1f2328);font-weight:600}.lfVxGa_groupRow{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;margin-bottom:10px;padding:12px 14px}.lfVxGa_groupHead{align-items:center;gap:10px;min-width:0;display:flex}.lfVxGa_groupName{text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:600;line-height:20px;overflow:hidden}.lfVxGa_groupActions{flex-shrink:0;align-items:center;gap:6px;display:flex}.lfVxGa_groupMembers{flex-direction:column;gap:6px;margin-top:10px;display:flex}.lfVxGa_groupMember{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:12px;line-height:18px;display:flex}.lfVxGa_groupMember .lfVxGa_nm{flex:1;min-width:0;font-size:12px}.lfVxGa_groupAddPanel{border-top:1px dashed var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:6px;margin-top:10px;padding-top:10px;display:flex}.lfVxGa_groupCreate{align-items:center;gap:8px;margin-bottom:10px;display:flex}.lfVxGa_inlineInput{flex:1;min-width:120px}.lfVxGa_assignRow{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.lfVxGa_assignSelect{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-1,#fff);color:var(--dsw-alias-label-primary,#1f2328);font:inherit;border-radius:6px;padding:3px 6px;font-size:12px;line-height:18px}.lfVxGa_groupHint{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:11px}.lfVxGa_sectAction{color:var(--dsw-alias-label-secondary,#6b7280);align-items:center;gap:8px;margin:14px 2px 8px;font-size:12px;font-weight:600;display:flex}.lfVxGa_backupGrid{grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:12px;display:grid}.lfVxGa_backupCard{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;gap:10px;padding:16px;display:flex}.lfVxGa_backupCard h3{margin:0;font-size:14px}.lfVxGa_backupCard p{color:var(--dsw-alias-label-secondary,#6b7280);margin:0;font-size:12px;line-height:18px}.lfVxGa_backupActions{flex-wrap:wrap;gap:8px;display:flex;position:relative}.lfVxGa_hiddenFile{opacity:0;pointer-events:none;width:1px;height:1px;position:absolute}.lfVxGa_backupInput{box-sizing:border-box;width:100%}.lfVxGa_backupCheck{cursor:pointer;align-items:center;gap:6px;font-size:12px;display:flex}.lfVxGa_backupWarn{margin:0;font-size:12px;line-height:18px;color:var(--dsw-alias-state-warn-primary,#b45309)!important}.lfVxGa_backupMessage{color:var(--dsw-alias-label-secondary,#6b7280);grid-column:1/-1;font-size:12px}.lfVxGa_backupCheckList{flex-direction:column;gap:6px;max-height:260px;margin:10px 0 4px;padding-right:4px;display:flex;overflow-y:auto}.lfVxGa_backupCheckList .lfVxGa_backupCheck{justify-content:space-between;gap:8px}.lfVxGa_diagPage{flex-direction:column;gap:12px;height:100%;min-height:0;display:flex;overflow-y:auto}.lfVxGa_diagSummary{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-wrap:wrap;align-items:center;gap:12px;padding:10px 14px;font-size:12px;display:flex}.lfVxGa_diagSummaryItem{color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;align-items:center;gap:6px;display:inline-flex}.lfVxGa_diagSummaryMeta{color:var(--dsw-alias-label-tertiary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;max-width:320px;font-family:ui-monospace,Menlo,monospace;font-size:11px;overflow:hidden}.lfVxGa_diagSection{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;gap:8px;padding:12px 14px;display:flex}.lfVxGa_diagSection h3{color:var(--dsw-alias-label-primary,#1f2328);margin:0;font-size:13px;font-weight:600}.lfVxGa_diagCount{color:var(--dsw-alias-label-tertiary,#9ca3af);font-size:11px;font-weight:400}.lfVxGa_diagEmpty{color:var(--dsw-alias-label-secondary,#9ca3af);padding:8px 0;font-size:12px}.lfVxGa_diagBundle{border-top:1px solid var(--dsw-alias-border-l2,#f0f1f3);flex-direction:column;gap:6px;padding-top:8px;display:flex}.lfVxGa_diagBundle:first-of-type{border-top:none;padding-top:0}.lfVxGa_diagRow{flex-wrap:wrap;align-items:center;gap:8px;min-width:0;font-size:12px;line-height:18px;display:flex}.lfVxGa_diagMeta{align-items:baseline;gap:8px;min-width:0;font-size:12px;display:flex}.lfVxGa_diagKey{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;min-width:64px;font-size:11px}.lfVxGa_diagVal{color:var(--dsw-alias-label-primary,#1f2328);overflow-wrap:anywhere;min-width:0;font-family:ui-monospace,Menlo,monospace;font-size:12px;font-weight:500}.lfVxGa_diagIndex{background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-width:18px;height:18px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;flex-shrink:0;justify-content:center;align-items:center;font-size:11px;font-weight:600;display:inline-flex}.lfVxGa_diagArrow{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;font-size:12px}.lfVxGa_diagBadgeOfficial{background:var(--dsw-alias-brand-primary,#4f6ef7);color:#fff;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.lfVxGa_diagBadgeCommunity{background:var(--dsw-alias-bg-layer-2,#f3f4f6);height:18px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;flex-shrink:0;align-items:center;padding:0 8px;font-size:11px;display:inline-flex}.lfVxGa_diagBadgeShadow{background:var(--dsw-alias-state-error-primary,#dc2626);color:#fff;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.lfVxGa_diagList{flex-direction:column;gap:6px;display:flex}.lfVxGa_sectionOverview{color:var(--dsw-alias-label-tertiary,#8b93a1);text-overflow:ellipsis;white-space:nowrap;max-width:100%;padding:2px 0 6px;font-size:12px;line-height:18px;overflow:hidden}.lfVxGa_diagAlert{color:var(--dsw-alias-state-warn-primary,#b45309)}.lfVxGa_ovRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-wrap:wrap;align-items:center;gap:8px;min-width:0;padding:6px 10px;font-size:12px;line-height:18px;display:flex}.lfVxGa_ovArrow{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;font-size:12px}.lfVxGa_ovByTag{background:var(--dsw-alias-brand-primary,#4f6ef7);color:#fff;text-overflow:ellipsis;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;max-width:260px;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex;overflow:hidden}.lfVxGa_ovFrom{color:var(--dsw-alias-label-secondary,#6b7280);text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:12px;overflow:hidden}.lfVxGa_orphRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-wrap:wrap;align-items:center;gap:8px;min-width:0;padding:6px 10px;font-size:12px;line-height:18px;display:flex}.lfVxGa_orphBadge{background:var(--dsw-alias-state-warn-primary,#b45309);color:#fff;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.lfVxGa_dragHandle{width:20px;height:20px;color:var(--dsw-alias-label-tertiary,#9ca3af);cursor:grab;user-select:none;flex-shrink:0;justify-content:center;align-items:center;font-size:12px;line-height:20px;display:inline-flex}.lfVxGa_dragOver{outline:2px dashed var(--dsw-alias-brand-primary,#4f6ef7);outline-offset:2px;background:var(--dsw-alias-bg-layer-2,#f0f2f8);border-radius:8px}.lfVxGa_dragging{opacity:.45;background:var(--dsw-alias-bg-layer-2,#f3f4f6)}.lfVxGa_collapseHead{font:inherit;color:var(--dsw-alias-label-primary,#1f2328);cursor:pointer;text-align:left;background:0 0;border:none;align-items:center;gap:8px;width:100%;padding:0;font-size:13px;font-weight:600;display:flex}.lfVxGa_collapseIcon{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;display:inline-flex}.lfVxGa_collapseTitle{flex:1;min-width:0}.lfVxGa_collapseBody{border-top:1px solid var(--dsw-alias-border-l2,#f0f1f3);overflow-wrap:anywhere;flex-direction:column;gap:10px;min-width:0;margin-top:8px;padding-top:10px;display:flex}.lfVxGa_panelNote{color:var(--dsw-alias-label-secondary,#6b7280);margin:0;font-size:12px;line-height:18px}.lfVxGa_fixFallback{flex-direction:column;gap:6px;margin:8px 0;display:flex}.lfVxGa_fixFallbackText{box-sizing:border-box;width:100%;color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);resize:vertical;white-space:pre-wrap;word-break:break-all;border-radius:6px;padding:8px 10px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:16px}.lfVxGa_setCard{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-3,#fff);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}.lfVxGa_setCard:hover{border-color:var(--dsw-alias-label-dimmed,#c8ccd4)}.lfVxGa_setCardOpen{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-color:var(--dsw-alias-label-dimmed,#c8ccd4)}.lfVxGa_setHeader{appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.lfVxGa_setHeader:focus-visible{outline:2px solid var(--dsw-alias-brand-primary,#4f6ef7);outline-offset:-2px}.lfVxGa_setHeadText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.lfVxGa_setName{color:var(--dsw-alias-label-primary,#1f2328);font-size:15px;font-weight:600;line-height:1.4}.lfVxGa_setDesc{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:13px;line-height:1.5}.lfVxGa_setChevron{color:var(--dsw-alias-label-tertiary,#8b93a1);flex:none;transition:transform .16s;display:inline-flex}.lfVxGa_setChevronOpen{transform:rotate(180deg)}.lfVxGa_setBody{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);margin:0 16px;padding-bottom:8px}.lfVxGa_setRow{align-items:center;gap:12px;padding:12px 0;display:flex}.lfVxGa_setRow+.lfVxGa_setRow{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb)}.lfVxGa_setLabelBox{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.lfVxGa_setLabel{font-size:13px;line-height:20px}.lfVxGa_setHint{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:12px;line-height:18px}.lfVxGa_setConfirm{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:8px;padding:12px 0 4px;display:flex}.lfVxGa_setCheck{cursor:pointer;align-items:center;gap:8px;font-size:12px;line-height:18px;display:flex}.lfVxGa_setActions{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}.lfVxGa_setDanger{color:var(--dsw-alias-state-error-primary,#dc2626)}.lfVxGa_setSeg{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;flex-shrink:0;gap:2px;padding:2px;display:inline-flex}.lfVxGa_setSegBtn{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;background:0 0;border:none;border-radius:6px;padding:3px 10px;font-size:12px;line-height:18px}.lfVxGa_setSegBtn:disabled{cursor:default;opacity:.5}.lfVxGa_setSegOn{background:var(--dsw-alias-bg-layer-2,#eef0f4);color:var(--dsw-alias-label-primary,#1f2328);font-weight:600}.lfVxGa_setBetaTag{background:var(--dsw-alias-bg-module-platform,#eef0f4);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;margin-left:6px;padding:0 6px;font-size:11px;font-weight:600;line-height:17px}";
		...
		var Market_module_css_default = {
			"progress": "lfVxGa_progress",
			"groupActions": "lfVxGa_groupActions",
			"irowMissing": "lfVxGa_irowMissing",
			"opStatus": "lfVxGa_opStatus",
			"setSegOn": "lfVxGa_setSegOn",
			"logoPlug": "lfVxGa_logoPlug",
			"retryBtn": "lfVxGa_retryBtn",
			"choiceRadio": "lfVxGa_choiceRadio",
			"setChevron": "lfVxGa_setChevron",
			"lightboxNav": "lfVxGa_lightboxNav",
			"titleRow": "lfVxGa_titleRow",
			"star": "lfVxGa_star",
			"sectAction": "lfVxGa_sectAction",
			"catsWrap": "lfVxGa_catsWrap",
			"setHint": "lfVxGa_setHint",
			"rosterSplit": "lfVxGa_rosterSplit",
			"catsCollapsed": "lfVxGa_catsCollapsed",
			"cardBlockedMark": "lfVxGa_cardBlockedMark",
			"viewBtn": "lfVxGa_viewBtn",
			"setBody": "lfVxGa_setBody",
			"irow": "lfVxGa_irow",
			"specTag": "lfVxGa_specTag",
			"conflictIcon": "lfVxGa_conflictIcon",
			"tab": "lfVxGa_tab",
			"byline": "lfVxGa_byline",
			"opHead": "lfVxGa_opHead",
			"conflictDetailsToggle": "lfVxGa_conflictDetailsToggle",
			"lightboxPrev": "lfVxGa_lightboxPrev",
			"opEntryQuiet": "lfVxGa_opEntryQuiet",
			"conflictBody": "lfVxGa_conflictBody",
			"rosterTagKeep": "lfVxGa_rosterTagKeep",
			"orphBadge": "lfVxGa_orphBadge",
			"desc": "lfVxGa_desc",
			"opPanelTitle": "lfVxGa_opPanelTitle",
			"diagSection": "lfVxGa_diagSection",
			"specTagFile": "lfVxGa_specTagFile",
			"backupGrid": "lfVxGa_backupGrid",
			"version": "lfVxGa_version",
			"barWave": "lfVxGa_barWave",
			"catsRow": "lfVxGa_catsRow",
			"diagBadgeCommunity": "lfVxGa_diagBadgeCommunity",
			"ovArrow": "lfVxGa_ovArrow",
			"setCardOpen": "lfVxGa_setCardOpen",
			"diagKey": "lfVxGa_diagKey",
			"dshmPlugFade": "lfVxGa_dshmPlugFade",
			"themesGrid": "lfVxGa_themesGrid",
			"opEmpty": "lfVxGa_opEmpty",
			"root": "lfVxGa_root",
			"diagCount": "lfVxGa_diagCount",
			"diagAlert": "lfVxGa_diagAlert",
			"metaTag": "lfVxGa_metaTag",
			"opRowAlert": "lfVxGa_opRowAlert",
			"opWrap": "lfVxGa_opWrap",
			"backupCheckList": "lfVxGa_backupCheckList",
			"spec": "lfVxGa_spec",
			"hiddenFile": "lfVxGa_hiddenFile",
			"opIcon": "lfVxGa_opIcon",
			"diagArrow": "lfVxGa_diagArrow",
			"fixFallback": "lfVxGa_fixFallback",
			"rosterAuthor": "lfVxGa_rosterAuthor",
			"reassureOk": "lfVxGa_reassureOk",
			"cardShots": "lfVxGa_cardShots",
			"top": "lfVxGa_top",
			"assignSelect": "lfVxGa_assignSelect",
			"opDot": "lfVxGa_opDot",
			"shots": "lfVxGa_shots",
			"opDecisionFoot": "lfVxGa_opDecisionFoot",
			"dragHandle": "lfVxGa_dragHandle",
			"diagPage": "lfVxGa_diagPage",
			"diagEmpty": "lfVxGa_diagEmpty",
			"staleAction": "lfVxGa_staleAction",
			"groupRow": "lfVxGa_groupRow",
			"conflictWhy": "lfVxGa_conflictWhy",
			"stickyHead": "lfVxGa_stickyHead",
			"pct": "lfVxGa_pct",
			"actWarn": "lfVxGa_actWarn",
			"opMain": "lfVxGa_opMain",
			"irowTrailing": "lfVxGa_irowTrailing",
			"card": "lfVxGa_card",
			"grow": "lfVxGa_grow",
			"choiceTitle": "lfVxGa_choiceTitle",
			"opPanel": "lfVxGa_opPanel",
			"assignRow": "lfVxGa_assignRow",
			"specTagGit": "lfVxGa_specTagGit",
			"diagSummary": "lfVxGa_diagSummary",
			"setDanger": "lfVxGa_setDanger",
			"ovRow": "lfVxGa_ovRow",
			"setDesc": "lfVxGa_setDesc",
			"diagSummaryMeta": "lfVxGa_diagSummaryMeta",
			"opStatusBad": "lfVxGa_opStatusBad",
			"switch": "lfVxGa_switch",
			"collapseHead": "lfVxGa_collapseHead",
			"cats": "lfVxGa_cats",
			"setBetaTag": "lfVxGa_setBetaTag",
			"groupName": "lfVxGa_groupName",
			"swatches": "lfVxGa_swatches",
			"groupHead": "lfVxGa_groupHead",
			"title": "lfVxGa_title",
			"roster": "lfVxGa_roster",
			"src": "lfVxGa_src",
			"owner": "lfVxGa_owner",
			"pairGrid": "lfVxGa_pairGrid",
			"switchMixed": "lfVxGa_switchMixed",
			"dragging": "lfVxGa_dragging",
			"conflictHead": "lfVxGa_conflictHead",
			"backupWarn": "lfVxGa_backupWarn",
			"stateDot": "lfVxGa_stateDot",
			"backupCheck": "lfVxGa_backupCheck",
			"sectionOverview": "lfVxGa_sectionOverview",
			"opActions": "lfVxGa_opActions",
			"shot": "lfVxGa_shot",
			"metaInline": "lfVxGa_metaInline",
			"backupCard": "lfVxGa_backupCard",
			"pageEllipsis": "lfVxGa_pageEllipsis",
			"actBroken": "lfVxGa_actBroken",
			"opVerb": "lfVxGa_opVerb",
			"descTight": "lfVxGa_descTight",
			"diagIndex": "lfVxGa_diagIndex",
			"descToggle": "lfVxGa_descToggle",
			"opAggregateHint": "lfVxGa_opAggregateHint",
			"diagVal": "lfVxGa_diagVal",
			"ovByTag": "lfVxGa_ovByTag",
			"pager": "lfVxGa_pager",
			"groupMember": "lfVxGa_groupMember",
			"rosterMain": "lfVxGa_rosterMain",
			"setSeg": "lfVxGa_setSeg",
			"opQueuedIcon": "lfVxGa_opQueuedIcon",
			"setActions": "lfVxGa_setActions",
			"diagSummaryItem": "lfVxGa_diagSummaryItem",
			"ovFrom": "lfVxGa_ovFrom",
			"bannerIcon": "lfVxGa_bannerIcon",
			"spin": "lfVxGa_spin",
			"conflictWhyText": "lfVxGa_conflictWhyText",
			"setLabelBox": "lfVxGa_setLabelBox",
			"tabs": "lfVxGa_tabs",
			"lightboxNext": "lfVxGa_lightboxNext",
			"grid": "lfVxGa_grid",
			"orphRow": "lfVxGa_orphRow",
			"diagRow": "lfVxGa_diagRow",
			"setCheck": "lfVxGa_setCheck",
			"dot": "lfVxGa_dot",
			"lightboxDotOn": "lfVxGa_lightboxDotOn",
			"dragOver": "lfVxGa_dragOver",
			"nameLink": "lfVxGa_nameLink",
			"fixFallbackText": "lfVxGa_fixFallbackText",
			"choiceSafe": "lfVxGa_choiceSafe",
			"groupMembers": "lfVxGa_groupMembers",
			"dangerArmed": "lfVxGa_dangerArmed",
			"lightboxDots": "lfVxGa_lightboxDots",
			"diagList": "lfVxGa_diagList",
			"setChevronOpen": "lfVxGa_setChevronOpen",
			"diagMeta": "lfVxGa_diagMeta",
			"rosterName": "lfVxGa_rosterName",
			"groupAddPanel": "lfVxGa_groupAddPanel",
			"catsToggle": "lfVxGa_catsToggle",
			"setRow": "lfVxGa_setRow",
			"barFill": "lfVxGa_barFill",
			"choiceMain": "lfVxGa_choiceMain",
			"collapseBody": "lfVxGa_collapseBody",
			"row1": "lfVxGa_row1",
			"topBtn": "lfVxGa_topBtn",
			"opEntry": "lfVxGa_opEntry",
			"lightboxDot": "lfVxGa_lightboxDot",
			"foot": "lfVxGa_foot",
			"switchOn": "lfVxGa_switchOn",
			"groupCreate": "lfVxGa_groupCreate",
			"modalNote": "lfVxGa_modalNote",
			"repoLink": "lfVxGa_repoLink",
			"masonryCol": "lfVxGa_masonryCol",
			"loading": "lfVxGa_loading",
			"submitLink": "lfVxGa_submitLink",
			"choices": "lfVxGa_choices",
			"on": "lfVxGa_on",
			"opCloseBtn": "lfVxGa_opCloseBtn",
			"irowActions": "lfVxGa_irowActions",
			"backupInput": "lfVxGa_backupInput",
			"opRow": "lfVxGa_opRow",
			"panelNote": "lfVxGa_panelNote",
			"deprecate": "lfVxGa_deprecate",
			"cardAction": "lfVxGa_cardAction",
			"setHeader": "lfVxGa_setHeader",
			"stateTag": "lfVxGa_stateTag",
			"depLine": "lfVxGa_depLine",
			"dshmSlide": "lfVxGa_dshmSlide",
			"setConfirm": "lfVxGa_setConfirm",
			"warnLine": "lfVxGa_warnLine",
			"choice": "lfVxGa_choice",
			"empty": "lfVxGa_empty",
			"viewBar": "lfVxGa_viewBar",
			"setSegBtn": "lfVxGa_setSegBtn",
			"lightboxImg": "lfVxGa_lightboxImg",
			"setLabel": "lfVxGa_setLabel",
			"actLive": "lfVxGa_actLive",
			"conflictTitle": "lfVxGa_conflictTitle",
			"pageInfo": "lfVxGa_pageInfo",
			"cardBlocked": "lfVxGa_cardBlocked",
			"switchKnob": "lfVxGa_switchKnob",
			"okState": "lfVxGa_okState",
			"sub": "lfVxGa_sub",
			"bar": "lfVxGa_bar",
			"opEntryAlert": "lfVxGa_opEntryAlert",
			"reassure": "lfVxGa_reassure",
			"diagBundle": "lfVxGa_diagBundle",
			"groupHint": "lfVxGa_groupHint",
			"descClamp": "lfVxGa_descClamp",
			"nmLink": "lfVxGa_nmLink",
			"installBtn": "lfVxGa_installBtn",
			"logoMark": "lfVxGa_logoMark",
			"opAggregateTop": "lfVxGa_opAggregateTop",
			"lightbox": "lfVxGa_lightbox",
			"rosterRowOut": "lfVxGa_rosterRowOut",
			"choiceNote": "lfVxGa_choiceNote",
			"setName": "lfVxGa_setName",
			"meta": "lfVxGa_meta",
			"tabSearchRow": "lfVxGa_tabSearchRow",
			"opName": "lfVxGa_opName",
			"choiceOn": "lfVxGa_choiceOn",
			"setHeadText": "lfVxGa_setHeadText",
			"lightboxClose": "lfVxGa_lightboxClose",
			"bannerHint": "lfVxGa_bannerHint",
			"collapseIcon": "lfVxGa_collapseIcon",
			"head": "lfVxGa_head",
			"inlineInput": "lfVxGa_inlineInput",
			"subTabs": "lfVxGa_subTabs",
			"setCard": "lfVxGa_setCard",
			"banner": "lfVxGa_banner",
			"viewOn": "lfVxGa_viewOn",
			"act": "lfVxGa_act",
			"rosterRow": "lfVxGa_rosterRow",
			"pagerPages": "lfVxGa_pagerPages",
			"dshmPlug": "lfVxGa_dshmPlug",
			"cmd": "lfVxGa_cmd",
			"collapseTitle": "lfVxGa_collapseTitle",
			"rosterTag": "lfVxGa_rosterTag",
			"opAggregate": "lfVxGa_opAggregate",
			"opTop": "lfVxGa_opTop",
			"opEmptyHint": "lfVxGa_opEmptyHint",
			"diagBadgeShadow": "lfVxGa_diagBadgeShadow",
			"tag": "lfVxGa_tag",
			"actWhy": "lfVxGa_actWhy",
			"nm": "lfVxGa_nm",
			"masonry": "lfVxGa_masonry",
			"backupActions": "lfVxGa_backupActions",
			"av": "lfVxGa_av",
			"depBadge": "lfVxGa_depBadge",
			"body": "lfVxGa_body",
			"err": "lfVxGa_err",
			"metaTagOk": "lfVxGa_metaTagOk",
			"tabSearch": "lfVxGa_tabSearch",
			"sp": "lfVxGa_sp",
			"opDecision": "lfVxGa_opDecision",
			"diagBadgeOfficial": "lfVxGa_diagBadgeOfficial",
			"rosterTagDrop": "lfVxGa_rosterTagDrop",
			"dangerBtn": "lfVxGa_dangerBtn",
			"backupMessage": "lfVxGa_backupMessage",
			"cardShot": "lfVxGa_cardShot"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region lib/types/client/OperationsPanel.js
		/**
		...
		*/
		function OutcomePreview(props) {
			...
			const row = (key, info, kept, tag) => (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsxs)("span", {
						...
						children: [(0, react_jsx_runtime.jsx)("span", {
							...
							title: key,
							children: info.title
						}), info.author !== void 0 && (0, react_jsx_runtime.jsx)("span", {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsx)("div", { className: Market_module_css_default.rosterSplit }),
		...
		*/
		function ConflictChoice(props) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsx)(OutcomePreview, {
						t,
						record,
						choice,
					...
					(0, react_jsx_runtime.jsx)("div", {
						...
						children: CHOICES.map(({ id, label, note }) => (0, react_jsx_runtime.jsxs)("label", {
							...
							children: [(0, react_jsx_runtime.jsx)("input", {
								...
								children: [(0, react_jsx_runtime.jsx)("span", {
									...
									children: t(label)
								}), t(note) !== "" && (0, react_jsx_runtime.jsx)("span", {
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							(0, react_jsx_runtime.jsxs)("button", {
								...
								children: [t("conflictDetails"), whyOpen ? (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronUpOutline14, { size: 12 }) : (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronDownOutline14, { size: 12 })]
							}),
							(0, react_jsx_runtime.jsx)("span", { className: Market_module_css_default.grow }),
					...
					whyOpen && (0, react_jsx_runtime.jsxs)("div", {
						className: Market_module_css_default.conflictWhy,
						children: [(record.conflicts ?? []).map((group) => (0, react_jsx_runtime.jsxs)("div", { children: [
							group.owner,
							": ",
							group.ids.join(", ")
						] }, group.owner)), (0, react_jsx_runtime.jsx)("div", {
		...
		function BucketIcon(props) {
			...
			if (bucket === "busy") return props.record.state === "running" ? (0, react_jsx_runtime.jsx)("span", {
				className: Market_module_css_default.spin,
				children: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconLoadingOutline16, { size: 13 })
			}) : (0, react_jsx_runtime.jsx)("span", {
				className: Market_module_css_default.opQueuedIcon,
				children: "⋯"
			});
			if (bucket === "ok") return (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconCheckOutline16, {
				size: 13,
				className: Market_module_css_default.reassureOk
			});
			return (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconWarningOutline16, {
				size: 14,
		...
		function OperationsPanel(props) {
			...
			if (records.length === 0 && !open) return (0, react_jsx_runtime.jsx)("button", {
				type: "button",
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [(0, react_jsx_runtime.jsxs)("button", {
					...
					children: [
						busy && (0, react_jsx_runtime.jsx)("span", {
							className: Market_module_css_default.spin,
							children: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconLoadingOutline16, { size: 12 })
						}),
						label,
						summary.attention > 0 && (0, react_jsx_runtime.jsx)("span", { className: Market_module_css_default.opDot })
					]
					...
					children: [
						(0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								(0, react_jsx_runtime.jsx)("span", { className: Market_module_css_default.grow }),
								summary.settled > 0 && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
									variant: "ghost",
									size: "sm",
						...
						busy && (0, react_jsx_runtime.jsxs)("div", {
						...
						records.length === 0 && (0, react_jsx_runtime.jsxs)("div", {
							className: Market_module_css_default.opEmpty,
							children: [t("opEmpty"), (0, react_jsx_runtime.jsx)("div", {
							...
							return (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									(0, react_jsx_runtime.jsx)("span", {
										...
										children: (0, react_jsx_runtime.jsx)(BucketIcon, { record })
									}),
									(0, react_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											record.state === "running" && typeof record.percent === "number" && (0, react_jsx_runtime.jsx)("div", {
												className: Market_module_css_default.bar,
												children: (0, react_jsx_runtime.jsx)("div", {
													className: Market_module_css_default.barFill,
											...
											needsUser(record) && (0, react_jsx_runtime.jsx)(ConflictChoice, {
												t,
												record,
									...
									(0, react_jsx_runtime.jsxs)("div", {
										...
										children: [
											record.state === "running" && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
												variant: "outline",
												size: "sm",
												onClick: () => props.onCancel(record),
												children: t("cancelOp")
											}),
											record.state === "queued" && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
												variant: "ghost",
												size: "sm",
												onClick: () => props.onDismiss(record),
												children: t("opDequeue")
											}),
											record.state === "done" && record.needsRefresh === true && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
												variant: "primary",
												size: "sm",
												onClick: props.onRefresh,
												children: t("refresh")
											}),
											record.state === "failed" && props.onRetry !== void 0 && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
												variant: "outline",
												size: "sm",
												onClick: () => props.onRetry?.(record),
												children: t("opRetry")
											}),
											isSettled(record) && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
												variant: "ghost",
												size: "sm",
												onClick: () => props.onDismiss(record),
		...
		//#endregion
		//#region lib/types/client/Diagnostics.js
		/**
		...
		function Section(props) {
			...
			return (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					(0, react_jsx_runtime.jsxs)("button", {
						...
						children: [
							(0, react_jsx_runtime.jsx)("span", {
								...
								children: open ? (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronDownOutline14, { size: 14 }) : (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronRightOutline14, { size: 14 })
							}),
							alert && (0, react_jsx_runtime.jsx)("span", {
					...
					!open && overview !== void 0 && (0, react_jsx_runtime.jsx)("div", {
					...
					(0, react_jsx_runtime.jsx)("div", {
						...
						children: count === 0 && !alwaysShowBody ? (0, react_jsx_runtime.jsx)("div", {
			...
			return (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [(0, react_jsx_runtime.jsxs)("button", {
					...
					children: [
						...
						count !== void 0 && (0, react_jsx_runtime.jsxs)("span", {
							className: Market_module_css_default.diagCount,
							children: [
								"(",
								count,
		...
		*/
		function Diagnostics(props) {
			...
			* candidate composition (dry-run replay) before writing. */
			...
			if (report === null) return (0, react_jsx_runtime.jsxs)("div", {
				className: Market_module_css_default.loading,
				children: [(0, react_jsx_runtime.jsx)("span", {
					className: Market_module_css_default.spin,
					children: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconLoadingOutline16, { size: 22 })
				}), t("checkLoading")]
			});
				...
				children: [
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							(0, react_jsx_runtime.jsx)("span", { className: Market_module_css_default.grow }),
							hasHardIssues && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
								variant: "outline",
								size: "sm",
					...
					fixMsg !== null && (0, react_jsx_runtime.jsx)("div", {
						className: Market_module_css_default.okState,
						children: fixMsg
					}),
					fixFallback !== null && (0, react_jsx_runtime.jsxs)("div", {
					...
					(0, react_jsx_runtime.jsxs)(CollapsibleSection, {
						title: t("diagExplain"),
						open: explainOpen,
					...
					(0, react_jsx_runtime.jsx)(Section, {
						...
						children: (0, react_jsx_runtime.jsx)("div", {
							className: Market_module_css_default.diagList,
							children: summary.errors.map((line, i) => (0, react_jsx_runtime.jsx)("div", {
								className: Market_module_css_default.err,
								children: line
							}, i))
						})
					...
					(0, react_jsx_runtime.jsx)(Section, {
						...
						children: (0, react_jsx_runtime.jsx)("div", {
							className: Market_module_css_default.diagList,
							children: summary.warnings.map((line, i) => (0, react_jsx_runtime.jsx)("div", {
								className: Market_module_css_default.warnLine,
								children: (0, react_jsx_runtime.jsx)("span", { children: line })
							}, i))
						})
					}),
					(0, react_jsx_runtime.jsx)(Section, {
						...
						problem: false,
						overview: (0, react_jsx_runtime.jsxs)("span", { children: [
							t("checkOfficial"),
							" × ",
						...
						children: report.bundles.map((bundle, i) => (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								(0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										bundle.error !== null && (0, react_jsx_runtime.jsx)("span", {
											className: Market_module_css_default.err,
											children: bundle.error
										}),
										bundle.parseError !== null && (0, react_jsx_runtime.jsxs)("span", {
											className: Market_module_css_default.err,
											children: [
												t("checkPatch"),
												": ",
								...
								bundle.directory !== null && (0, react_jsx_runtime.jsxs)("div", {
									className: Market_module_css_default.diagMeta,
									children: [(0, react_jsx_runtime.jsx)("span", {
										className: Market_module_css_default.diagKey,
										children: t("checkDir")
								...
								bundle.patchPath !== null && (0, react_jsx_runtime.jsxs)("div", {
									className: Market_module_css_default.diagMeta,
									children: [(0, react_jsx_runtime.jsx)("span", {
										className: Market_module_css_default.diagKey,
					...
					(0, react_jsx_runtime.jsx)(Section, {
						...
						children: (0, react_jsx_runtime.jsx)("div", {
							className: Market_module_css_default.diagList,
							children: report.duplicates.map((dup) => (0, react_jsx_runtime.jsxs)("div", {
								className: Market_module_css_default.diagRow,
								children: [
									(0, react_jsx_runtime.jsx)("code", {
					...
					(0, react_jsx_runtime.jsxs)(Section, {
						...
						children: [peerConfirmed.length === 0 ? (0, react_jsx_runtime.jsx)("div", {
							className: Market_module_css_default.diagEmpty,
							children: t("checkPeerEmpty")
						}) : (0, react_jsx_runtime.jsx)("div", {
							className: Market_module_css_default.diagList,
							children: peerConfirmed.map((peer, i) => (0, react_jsx_runtime.jsxs)("div", {
								className: Market_module_css_default.diagRow,
								children: [
									(0, react_jsx_runtime.jsx)("code", {
										className: Market_module_css_default.diagVal,
						...
						}), peerInfo.length > 0 && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.DisclosureRow, {
							icon: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronDownOutline14, { size: 14 }),
							...
							children: (0, react_jsx_runtime.jsx)("div", {
								className: Market_module_css_default.diagList,
								children: peerInfo.map((peer, i) => (0, react_jsx_runtime.jsxs)("div", {
									className: Market_module_css_default.diagRow,
									children: [
										(0, react_jsx_runtime.jsx)("code", {
											className: Market_module_css_default.diagVal,
										...
										peer.satisfied === true ? (0, react_jsx_runtime.jsx)("span", {
											className: Market_module_css_default.okState,
					...
					(0, react_jsx_runtime.jsx)(Section, {
						...
						children: (0, react_jsx_runtime.jsx)("div", {
							className: Market_module_css_default.diagList,
							children: report.multiVersion.map((mv) => (0, react_jsx_runtime.jsxs)("div", {
								className: Market_module_css_default.diagRow,
								children: [
									(0, react_jsx_runtime.jsx)("code", {
										className: Market_module_css_default.diagVal,
									...
									mv.hoisted !== null && (0, react_jsx_runtime.jsxs)("span", {
										className: Market_module_css_default.spec,
										children: [
											t("checkHoisted"),
											": ",
					...
					(0, react_jsx_runtime.jsx)(Section, {
						...
						children: (0, react_jsx_runtime.jsx)("div", {
							className: Market_module_css_default.diagList,
							children: report.overrides.map((ov, i) => (0, react_jsx_runtime.jsxs)("div", {
					...
					(0, react_jsx_runtime.jsx)(Section, {
						...
						children: (0, react_jsx_runtime.jsx)("div", {
							className: Market_module_css_default.diagList,
							children: report.orphans.map((orphan, i) => (0, react_jsx_runtime.jsxs)("div", {
					...
					(0, react_jsx_runtime.jsxs)(CollapsibleSection, {
						...
						children: [
							...
							report.orderConflicts !== void 0 && report.orderConflicts.length > 0 && (0, react_jsx_runtime.jsxs)("div", {
								className: Market_module_css_default.diagList,
								children: [(0, react_jsx_runtime.jsx)("span", {
									className: Market_module_css_default.diagKey,
									children: t("orderConflicts")
								}), report.orderConflicts.map((conflict, i) => (0, react_jsx_runtime.jsxs)("div", {
									className: Market_module_css_default.warnLine,
									children: [
										conflict.name,
										" — ",
							...
							(0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									suggested !== null && suggested.ok === true && suggested.order.join("\0") !== communityNames.join("\0") && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
										variant: "outline",
										size: "sm",
										disabled: orderBusy,
									...
									suggested !== null && suggested.ok === true && suggested.order.join("\0") === communityNames.join("\0") && (0, react_jsx_runtime.jsx)("span", {
										className: Market_module_css_default.okState,
										children: t("orderAlreadyOptimal")
									}),
									order.join("\0") !== communityNames.join("\0") && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
										variant: "ghost",
										size: "sm",
										disabled: orderBusy,
									...
									orderMsg !== null && (0, react_jsx_runtime.jsx)("span", {
										className: Market_module_css_default.okState,
										children: orderMsg
									}),
									orderErr !== null && (0, react_jsx_runtime.jsx)("span", {
										className: Market_module_css_default.err,
										children: orderErr
									})
								]
							}),
							orderDiff !== null && (0, react_jsx_runtime.jsx)("div", {
								className: Market_module_css_default.panelNote,
							...
							suggested !== null && suggested.ok === false && (0, react_jsx_runtime.jsxs)("div", {
								className: Market_module_css_default.warnLine,
								children: [
									t("orderSuggestHint"),
									" ⚠ ",
							...
							report.duplicateNames !== void 0 && report.duplicateNames.length > 0 && (0, react_jsx_runtime.jsxs)("div", {
								className: Market_module_css_default.diagList,
								children: [(0, react_jsx_runtime.jsx)("span", {
									className: Market_module_css_default.diagKey,
									children: t("duplicateNames")
								}), report.duplicateNames.map((dup, i) => (0, react_jsx_runtime.jsxs)("div", {
									className: Market_module_css_default.panelNote,
									children: [
										dup.name,
										" × ",
							...
							order.length === 0 ? (0, react_jsx_runtime.jsx)("div", {
								className: Market_module_css_default.diagEmpty,
								children: "—"
							}) : (0, react_jsx_runtime.jsx)("div", {
								className: Market_module_css_default.diagList,
								children: order.map((name, i) => (0, react_jsx_runtime.jsxs)("div", {
									draggable: !orderBusy,
									className: [
		...
		//#endregion
		//#region lib/types/client/MarketSection.js
		/**
		...
		function HostDependencyDiagnostics({ findings, t }) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconWarningOutline16, {
					...
					children: [
						(0, react_jsx_runtime.jsx)("div", { children: t("hostDependencyWarning") }),
						preview.map((finding) => (0, react_jsx_runtime.jsxs)("div", {
							className: Market_module_css_default.spec,
							children: [
						...
						remaining > 0 && (0, react_jsx_runtime.jsx)("div", {
							className: Market_module_css_default.spec,
		...
		function FilterMenu({ sortField, sortDir, timeRange, onSortField, onSortDir, onTimeRange, t }) {
			...
			return (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Menu, {
				...
				anchor: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
					variant: "outline",
					size: "sm",
					icon: open ? (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronUpOutline14, { size: 14 }) : (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronDownOutline14, { size: 14 }),
					onClick: () => setOpen((o) => !o),
					children: t("filter")
				}),
				items
		...
		function Pager({ currentPage, totalPages, pageSize, onGoToPage, onChangePageSize, t }) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [(0, react_jsx_runtime.jsx)("div", {
					...
					children: totalPages > 1 && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
						(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
							variant: "outline",
							size: "sm",
						...
						(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
							variant: "outline",
							size: "sm",
							icon: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronLeftOutline14, { size: 14 }),
							disabled: currentPage === 1,
							onClick: () => onGoToPage(currentPage - 1),
							children: t("prevPage")
						}),
						pageItems(currentPage, totalPages).map((item, i) => item === "…" ? (0, react_jsx_runtime.jsx)("span", {
							className: Market_module_css_default.pageEllipsis,
							children: "…"
						}, "e" + i) : (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
						...
						(0, react_jsx_runtime.jsxs)(_deepseek_ai_dsh_client_ui_primitives.Button, {
							...
							onClick: () => onGoToPage(currentPage + 1),
							children: [t("nextPage"), (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronRightOutline14, { size: 14 })]
						}),
						(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
							variant: "outline",
							size: "sm",
		...
		*/
		function OwnerAvatar({ name, owner }) {
			...
			if (failed || owner === "") return (0, react_jsx_runtime.jsx)("div", {
		...
		*/
		function ScreenshotStrip({ plugin, onOpen }) {
			...
			return (0, react_jsx_runtime.jsx)("div", {
				...
				children: visible.map((src, i) => (0, react_jsx_runtime.jsx)("img", {
		...
		*/
		function Masonry({ items, render, columns = 2 }) {
			if (!useMediaWide() || columns < 2) return (0, react_jsx_runtime.jsx)("div", {
			...
			return (0, react_jsx_runtime.jsx)("div", {
				className: Market_module_css_default.masonry,
				children: buckets.map((bucket, index) => (0, react_jsx_runtime.jsx)("div", {
					className: Market_module_css_default.masonryCol,
		...
		*/
		function useMediaWide() {
			...
			return (0, react.useSyncExternalStore)((0, react.useCallback)((notify) => {
				if (typeof matchMedia !== "function") return () => {};
				const list = matchMedia(query);
				list.addEventListener("change", notify);
				return () => list.removeEventListener("change", notify);
			}, []), () => typeof matchMedia === "function" ? matchMedia(query).matches : true, () => true);
		}
		/**
		...
		*/
		function CardDesc({ text, t }) {
			...
			return (0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("div", {
				...
				children: expanded ? (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronUpOutline14, { size: 14 }) : (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronDownOutline14, { size: 14 })
			})] });
		}
		/**
		...
		function ScreenshotLightbox({ shots, startIndex, onClose, t }) {
			...
			return (0, react_dom.createPortal)((0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					shots.length > 1 && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
						(0, react_jsx_runtime.jsx)("button", {
							...
							children: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronLeftOutline14, { size: 18 })
						}),
						(0, react_jsx_runtime.jsx)("button", {
							...
							children: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronRightOutline14, { size: 18 })
						}),
						(0, react_jsx_runtime.jsx)("div", {
							className: Market_module_css_default.lightboxDots,
							onClick: (e) => e.stopPropagation(),
							children: shots.map((src, i) => (0, react_jsx_runtime.jsx)("span", {
		...
		*/
		...
		function MarketSection(props) {
			...
			*/
			const describePlugin = (0, react.useCallback)((name) => {
				...
				return {
					...
					avatar: (0, react_jsx_runtime.jsx)(OwnerAvatar, {
						name: entry.name,
						owner: entry.owner || ""
					})
				};
			...
			*  pinned during scroll, distinct from the two-row collapsed default. */
			...
			const refreshInstalled = (0, react.useCallback)((force) => {
				fetch("/dsh-market/installed", { cache: "no-store" }).then((res) => res.json()).then((body) => {
					...
					setHostDependencyFindings(body.diagnostics?.schema === "dsh-market/diagnostics/v1" && Array.isArray(body.diagnostics.findings) ? body.diagnostics.findings.filter(isHostDependencyFinding) : []);
				}).catch(() => {});
			...
			const effectiveDisabledSet = (0, react.useMemo)(() => new Set([...disabledNames, ...patchDisabledNames]), [disabledNames, patchDisabledNames]);
			...
			const scrollToTop = () => {
				...
				if (el) if (typeof el.scrollTo === "function") el.scrollTo({
					top: 0,
					behavior: "smooth"
				});
				else el.scrollTop = 0;
				...
				fetch("/dsh-market/install", {
					...
					if (status === 200 && body.ok) {
						...
						if (body.activation && typeof body.activation === "object") {
							...
							setActivationWarnings(Object.entries(body.activation).filter(([, info]) => info.state !== "live" && info.state !== "missing").map(([name, info]) => ({
								name,
								info
							})));
						}
			...
			* immediately (mirrors the use-skin reload on activate). */
			...
			const doGroupAction = (0, react.useCallback)((payload) => {
				...
				return fetch("/dsh-market/groups", {
					...
					if (status === 200 && body.ok) {
						...
						if (Array.isArray(body.refreshMembers) && body.refreshMembers.length > 0) setRefreshNames((names) => [...new Set([...names, ...body.refreshMembers])]);
						refreshInstalled();
						return true;
					}
					const text = (v) => typeof v === "string" ? v : v == null ? "" : JSON.stringify(v);
			...
			const doRemoveMember = (0, react.useCallback)((group, name) => {
				doGroupAction({
					action: "set-members",
					name: group,
					members: (groups[group] ?? []).filter((member) => member !== name)
				});
			...
			const exportOptions = (0, react.useMemo)(() => {
				return [...new Set([...Object.keys(installed), ...installedBundles])].sort();
			...
			(0, react.useEffect)(() => {
				...
				if (Date.now() - last >= 1440 * 60 * 1e3) runWebdav("backup");
			}, [
				autoBackup,
				runWebdav,
				webdavUrl,
			...
			const pluginCard = (p) => {
				...
				return (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
							...
							children: [
								(0, react_jsx_runtime.jsxs)("div", {
									...
									children: [(0, react_jsx_runtime.jsxs)("a", {
										...
										rel: "noreferrer",
										title: p.name,
										children: [pluginName(p.name), p.deprecated === true && (0, react_jsx_runtime.jsx)("span", {
										...
										children: [
											(0, react_jsx_runtime.jsx)(OwnerAvatar, {
												name: p.name,
												owner: p.owner || ""
											}),
											(0, react_jsx_runtime.jsx)("span", {
											...
											typeof p.downloads === "number" && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
											...
											typeof p.stars === "number" && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
								...
								(0, react_jsx_runtime.jsx)("div", {
									...
									children: done ? (0, react_jsx_runtime.jsx)("span", {
										className: Market_module_css_default.okState,
										children: t("installedBadge")
									}) : already ? (0, react_jsx_runtime.jsx)("span", {
										className: Market_module_css_default.okState,
										children: t("alreadyInstalled")
									}) : busy ? (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
										variant: "primary",
										size: "sm",
										className: Market_module_css_default.installBtn,
										disabled: true,
										children: t("installing")
									}) : blocked ? (0, react_jsx_runtime.jsxs)("button", {
										type: "button",
										className: Market_module_css_default.cardBlockedMark,
										onClick: openOperations,
										children: [(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconWarningOutline16, { size: 13 }), t("opBlockedCard")]
									}) : (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
										variant: "primary",
										size: "sm",
										className: Market_module_css_default.installBtn,
						...
						(0, react_jsx_runtime.jsx)(CardDesc, {
							text: desc,
							t
						}),
						(0, react_jsx_runtime.jsx)(CardShot, {
							plugin: p,
							onOpen: openLightbox
						}),
						p.deprecated === true && (0, react_jsx_runtime.jsx)("div", {
							className: Market_module_css_default.deprecate,
							children: (0, react_jsx_runtime.jsxs)("div", {
								className: Market_module_css_default.depLine,
								children: [(0, react_jsx_runtime.jsxs)("span", { children: ["⚠️ ", t("deprecatedWarn")] }), replacement !== void 0 && (0, react_jsx_runtime.jsx)("a", {
						...
						busy && (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								(0, react_jsx_runtime.jsx)("span", {
									className: Market_module_css_default.spin,
									children: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconLoadingOutline16, { size: 14 })
								}),
								(0, react_jsx_runtime.jsx)("code", {
									className: Market_module_css_default.grow,
									children: progressText
								}),
								progressPct !== null && (0, react_jsx_runtime.jsxs)("span", {
				...
				return (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						(0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								(0, react_jsx_runtime.jsx)("span", { className: Market_module_css_default.grow }),
								removingName === instName ? (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
									variant: "outline",
									size: "sm",
									disabled: true,
								...
								effectiveDisabledSet.has(instName) && (0, react_jsx_runtime.jsx)("span", {
									className: Market_module_css_default.spec,
									children: t("disabledState")
								}),
								mounted ? (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)("span", {
									className: Market_module_css_default.okState,
			...
			const themeCard = (id, label, swatch) => {
				...
				return (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [(0, react_jsx_runtime.jsx)("div", {
						...
						children: swatch.map((c, i) => (0, react_jsx_runtime.jsx)("i", { style: { background: c } }, i))
					}), (0, react_jsx_runtime.jsxs)("div", {
						className: Market_module_css_default.foot,
						children: [
							(0, react_jsx_runtime.jsx)("span", {
			...
			* separate.
			*/
			const pendingRefreshNames = (0, react.useMemo)(() => [...new Set([...hotNames, ...refreshNames])], [hotNames, refreshNames]);
			...
			* mirror of the server's classification; themes are exclusive per group). */
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							(0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									(0, react_jsx_runtime.jsx)(MarketLogo, {
										size: 22,
										style: { flexShrink: 0 }
									}),
									...
									version !== null && (0, react_jsx_runtime.jsxs)("span", {
									...
									(() => {
										...
										return updates[self] && updates[self].updateAvailable && !updatedNames.includes(self) && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
											variant: "primary",
											size: "sm",
									...
									updatableNames.length >= 2 && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
										variant: "primary",
										size: "sm",
							...
							(0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									(0, react_jsx_runtime.jsx)("span", { children: t("subtitle") }),
									(0, react_jsx_runtime.jsx)("a", {
							...
							(0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									themeSnap !== null && (0, react_jsx_runtime.jsx)("button", {
									...
									(0, react_jsx_runtime.jsxs)("button", {
										...
										children: [t("tabInstalled") + (installedOtherCount > 0 ? " (" + installedOtherCount + ")" : ""), hasUpdates && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.StateDot, {
											state: "error",
											size: 7,
									...
									(0, react_jsx_runtime.jsx)("span", { className: Market_module_css_default.grow }),
									(0, react_jsx_runtime.jsx)(OperationsPanel, {
										t,
							...
							(tab === "backup" || tab === "diagnostics") && (0, react_jsx_runtime.jsxs)("div", {
							...
							!envReady && (0, react_jsx_runtime.jsxs)("div", {
								className: Market_module_css_default.banner,
								children: [
									(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconCordisPluginOutline14, {
										size: 14,
										className: Market_module_css_default.bannerIcon
									}),
									(0, react_jsx_runtime.jsx)("span", {
									...
									!envFailed && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
										variant: "primary",
										size: "sm",
										disabled: envFixing,
										onClick: fixEnv,
							...
							backupMessage !== null && (0, react_jsx_runtime.jsx)("div", {
								className: Market_module_css_default.backupMessage,
								children: backupMessage
							}),
							restoreErrors.length > 0 && (0, react_jsx_runtime.jsxs)("div", {
								className: Market_module_css_default.banner,
								children: [(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconWarningOutline16, {
									size: 14,
									className: Market_module_css_default.bannerIcon
									...
									className: Market_module_css_default.grow,
									children: [(0, react_jsx_runtime.jsx)("div", { children: (0, react_jsx_runtime.jsx)("b", { children: t("restorePartial") }) }), restoreErrors.map((error) => (0, react_jsx_runtime.jsx)("div", {
										className: Market_module_css_default.spec,
										children: error
									}, error))]
								})]
							}),
							tab === "installed" && pendingBackup !== null && (0, react_jsx_runtime.jsxs)("div", {
								className: Market_module_css_default.banner,
								children: [
							...
							pendingRefreshNames.length > 0 && (0, react_jsx_runtime.jsxs)("div", {
								className: Market_module_css_default.banner,
								children: [
									...
									(0, react_jsx_runtime.jsxs)("span", {
										className: Market_module_css_default.grow,
										children: [
											(0, react_jsx_runtime.jsx)("b", { children: pendingRefreshNames.length }),
											" ",
											t("refreshBanner")
										]
									}),
							...
							pendingRestart > 0 && (0, react_jsx_runtime.jsxs)("div", {
								className: Market_module_css_default.banner,
								children: [
									(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconRefreshOutline14, {
										size: 14,
									...
									(0, react_jsx_runtime.jsxs)("span", {
										className: Market_module_css_default.grow,
										children: [
											(0, react_jsx_runtime.jsx)("b", { children: pendingRestart }),
											" ",
											t("restartBanner")
										]
									}),
									...
									restartEnabled && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
										variant: "primary",
										size: "sm",
									...
									showHostPending && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
										variant: "ghost",
										size: "sm",
							...
							activationWarnings.length > 0 && (0, react_jsx_runtime.jsxs)("div", {
								className: Market_module_css_default.banner,
								children: [(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconWarningOutline16, {
									size: 14,
									className: Market_module_css_default.bannerIcon
									...
									className: Market_module_css_default.grow,
									children: activationWarnings.map(({ name, info }) => (0, react_jsx_runtime.jsxs)("div", { children: [
										(0, react_jsx_runtime.jsx)("b", { children: name }),
										" — ",
										activationMeta(info.state, t).label,
										info.reasons.length > 0 && (0, react_jsx_runtime.jsxs)("span", {
											className: Market_module_css_default.spec,
											children: [
												"（",
												info.reasons.join(" / "),
							...
							tab === "installed" && (0, react_jsx_runtime.jsx)(HostDependencyDiagnostics, {
								findings: hostDependencyFindings,
								t
							})
						]
					}),
					buildsSkipped !== null && (0, react_jsx_runtime.jsxs)("div", {
						className: Market_module_css_default.banner,
						children: [
					...
					compatibilityNotice !== null && (0, react_jsx_runtime.jsxs)("div", {
						className: Market_module_css_default.banner,
						children: [
							(0, react_jsx_runtime.jsxs)("span", {
								className: Market_module_css_default.grow,
								children: [
									compatibilityNotice.risks.length > 0 && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
										(0, react_jsx_runtime.jsx)("b", { children: t("compatRiskBanner") }),
										" ",
										compatibilitySummary(compatibilityNotice.risks)
									] }),
									compatibilityNotice.shadowedNames !== void 0 && compatibilityNotice.shadowedNames.length > 0 && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
										compatibilityNotice.risks.length > 0 && " · ",
										(0, react_jsx_runtime.jsx)("b", { children: t("shadowNameBanner") }),
										" ",
										shadowSummary(compatibilityNotice.shadowedNames)
									] }),
									compatibilityNotice.brokenBundles !== void 0 && compatibilityNotice.brokenBundles.length > 0 && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
										(compatibilityNotice.risks.length > 0 || (compatibilityNotice.shadowedNames?.length ?? 0) > 0) && " · ",
										(0, react_jsx_runtime.jsx)("b", { children: t("brokenBundleBanner") }),
										" ",
					...
					installError !== null && (0, react_jsx_runtime.jsxs)("div", {
						className: Market_module_css_default.err,
						children: [installError, (0, react_jsx_runtime.jsxs)("div", {
							className: Market_module_css_default.staleAction,
							children: [staleName !== null && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
								size: "sm",
					...
					(0, react_jsx_runtime.jsx)("div", {
						...
						children: tab === "backup" ? (0, react_jsx_runtime.jsxs)("div", {
							className: Market_module_css_default.backupGrid,
							children: [
								(0, react_jsx_runtime.jsxs)("section", {
									className: Market_module_css_default.backupCard,
									children: [
										(0, react_jsx_runtime.jsx)("h3", { children: t("backupLocal") }),
										(0, react_jsx_runtime.jsx)("p", { children: t("backupHint") }),
										(0, react_jsx_runtime.jsx)("p", {
								...
								(0, react_jsx_runtime.jsxs)("section", {
									className: Market_module_css_default.backupCard,
									children: [
										(0, react_jsx_runtime.jsx)("h3", { children: t("webdav") }),
										(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Menu, {
											open: presetOpen,
										...
										(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Input, {
											...
											icon: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconLinkOutline14, { size: 14 }),
											type: "url",
											value: webdavUrl,
										...
										(0, react_jsx_runtime.jsx)("p", { children: t("webdavNote") }),
										(0, react_jsx_runtime.jsx)("p", {
											className: Market_module_css_default.backupWarn,
											children: t("credsWarning")
										})
								...
								(0, react_jsx_runtime.jsxs)("section", {
									className: Market_module_css_default.backupCard,
									children: [
										(0, react_jsx_runtime.jsx)("h3", { children: t("gist") }),
										(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Input, {
											className: Market_module_css_default.backupInput,
											type: "password",
											autoComplete: "off",
										...
										gistResult !== null && (0, react_jsx_runtime.jsxs)("p", {
											className: Market_module_css_default.backupCheck,
											children: [
												(0, react_jsx_runtime.jsx)("span", { children: t("gistCreated") }),
												" ",
												(0, react_jsx_runtime.jsx)("a", {
													className: Market_module_css_default.src,
										...
										gistMessage !== null && (0, react_jsx_runtime.jsx)("div", {
											className: gistOk ? Market_module_css_default.backupMessage : Market_module_css_default.backupWarn,
											children: gistMessage
										}),
										(0, react_jsx_runtime.jsx)("p", { children: t("gistNote") })
									]
								})
							]
						}) : tab === "discover" ? loadError !== null ? (0, react_jsx_runtime.jsxs)("div", {
							className: Market_module_css_default.empty,
							children: [
								(0, react_jsx_runtime.jsx)("div", { children: t("loadFail") }),
								(0, react_jsx_runtime.jsx)("div", {
									className: Market_module_css_default.err,
									children: loadError
								}),
						...
						}) : data === null ? (0, react_jsx_runtime.jsxs)("div", {
							className: Market_module_css_default.loading,
							children: [(0, react_jsx_runtime.jsx)("span", {
								className: Market_module_css_default.logoMark,
								children: (0, react_jsx_runtime.jsx)(MarketLogo, {
									size: 26,
									animated: true
								})
							}), t("loading")]
						}) : (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
							(0, react_jsx_runtime.jsx)("div", { ref: setCatsSentinel }),
							(0, react_jsx_runtime.jsxs)("div", {
								...
								children: [(0, react_jsx_runtime.jsx)("div", {
									...
									children: (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [(0, react_jsx_runtime.jsx)("div", {
											...
											children: (() => {
												...
												return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
													...
													shown.map((id) => (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Pill, {
														"data-chip": "1",
														active: cat === id,
														onClick: () => setCat(id),
													...
													(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
														...
														icon: catsOpen ? (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronUpOutline14, { size: 14 }) : (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronDownOutline14, { size: 14 }),
										...
										}), (0, react_jsx_runtime.jsx)(FilterMenu, {
											sortField,
											sortDir,
											timeRange,
							...
							plugins.length === 0 ? (0, react_jsx_runtime.jsx)("div", {
								className: Market_module_css_default.empty,
								children: t("empty")
							}) : (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)(Masonry, {
								items: pagePlugins,
								render: pluginCard
							}), (0, react_jsx_runtime.jsx)(Pager, {
								currentPage,
								totalPages,
								pageSize,
								onGoToPage: goToPage,
						...
						] }) : tab === "themes" && themeSnap !== null ? (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
							(0, react_jsx_runtime.jsx)("div", {
								className: Market_module_css_default.tabSearchRow,
								children: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Input, {
									className: Market_module_css_default.tabSearch,
							...
							(() => {
								...
								return extra.length > 0 && (0, react_jsx_runtime.jsx)("div", {
							...
							(0, react_jsx_runtime.jsx)("div", {
								...
								children: (0, react_jsx_runtime.jsxs)("div", {
									className: Market_module_css_default.catsRow,
									children: [(0, react_jsx_runtime.jsx)("span", { className: Market_module_css_default.grow }), (0, react_jsx_runtime.jsx)(FilterMenu, {
							...
							}) : anyThemePlugins.length === 0 ? (0, react_jsx_runtime.jsx)("div", {
								className: Market_module_css_default.empty,
								children: t("themeEmpty")
							}) : themePlugins$1.length === 0 ? (0, react_jsx_runtime.jsx)("div", {
								className: Market_module_css_default.empty,
								children: t("empty")
							}) : (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)(Masonry, {
						...
						] }) : tab === "diagnostics" ? (0, react_jsx_runtime.jsx)(Diagnostics, { t }) : (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
							(0, react_jsx_runtime.jsxs)("div", {
							...
							installedView === "groups" ? (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
								(0, react_jsx_runtime.jsx)("div", {
									className: Market_module_css_default.groupCreate,
									children: creatingGroup ? (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
										(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Input, {
								...
								groupOrder.length === 0 ? (0, react_jsx_runtime.jsx)("div", {
									className: Market_module_css_default.empty,
									children: t("noGroups")
								}) : groupOrder.map((gid) => {
										...
										children: [
											(0, react_jsx_runtime.jsxs)("div", {
												...
												children: [
													(0, react_jsx_runtime.jsx)("button", {
														...
														children: (0, react_jsx_runtime.jsx)("span", { className: Market_module_css_default.switchKnob })
													}),
													(0, react_jsx_runtime.jsx)("span", {
														className: Market_module_css_default.groupName,
														children: gid
													}),
													sw === "mixed" && (0, react_jsx_runtime.jsx)("span", {
													...
													(0, react_jsx_runtime.jsxs)("div", {
														...
														children: [
															renamingGroup === gid ? (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
																(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Input, {
																	className: Market_module_css_default.inlineInput,
																	placeholder: t("groupNamePh"),
																	value: renamingValue,
															...
															deletingGroup === gid ? (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
																variant: "primary",
																size: "sm",
											...
											addPanel !== null && addPanel.group === gid && (() => {
												...
												return (0, react_jsx_runtime.jsx)("div", {
													...
													children: candidates.length === 0 ? (0, react_jsx_runtime.jsx)("div", {
													...
													}) : candidates.map((name) => (0, react_jsx_runtime.jsxs)("div", {
														...
														children: [
															...
															effectiveDisabledSet.has(name) && (0, react_jsx_runtime.jsx)("span", {
																className: Market_module_css_default.spec,
																children: t("disabledState")
															}),
															(0, react_jsx_runtime.jsx)("span", { className: Market_module_css_default.grow }),
											...
											(0, react_jsx_runtime.jsxs)("div", {
												...
												children: [members.length === 0 && (0, react_jsx_runtime.jsx)("div", {
													className: Market_module_css_default.groupHint,
													children: t("groupEmpty")
												}), members.map((member) => (0, react_jsx_runtime.jsxs)("div", {
													className: Market_module_css_default.groupMember,
													children: [
														(0, react_jsx_runtime.jsx)("span", {
															className: Market_module_css_default.nm,
														...
														effectiveDisabledSet.has(member) && (0, react_jsx_runtime.jsx)("span", {
															className: Market_module_css_default.spec,
															children: t("disabledState")
														}),
														(0, react_jsx_runtime.jsx)("span", { className: Market_module_css_default.grow }),
								...
								ungroupedNames.length === 0 ? (0, react_jsx_runtime.jsx)("div", {
									className: Market_module_css_default.empty,
									...
									return (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [
											(0, react_jsx_runtime.jsxs)("div", {
												...
												children: [(0, react_jsx_runtime.jsxs)("div", {
													className: Market_module_css_default.nm,
													children: [name, entry?.deprecated === true && (0, react_jsx_runtime.jsx)("span", {
														className: Market_module_css_default.depBadge,
														children: t("deprecatedBadge")
													})]
												}), (0, react_jsx_runtime.jsx)("div", {
													className: Market_module_css_default.act,
													children: off ? (0, react_jsx_runtime.jsxs)("span", {
											...
											(0, react_jsx_runtime.jsx)("span", { className: Market_module_css_default.grow }),
											assignFor === name ? (0, react_jsx_runtime.jsxs)("div", {
												...
												children: [
													(0, react_jsx_runtime.jsxs)("select", {
														...
														}), groupOrder.map((gid) => (0, react_jsx_runtime.jsx)("option", {
															value: gid,
															children: gid
														}, gid))]
													}),
							...
							] }) : Object.keys(displayedInstalled).filter((name) => name !== selfName).length === 0 ? (0, react_jsx_runtime.jsx)("div", {
								className: Market_module_css_default.empty,
								children: t("installedEmpty")
							}) : (0, react_jsx_runtime.jsx)("div", {
										...
										children: [(0, react_jsx_runtime.jsxs)("div", {
											...
											children: [
												(0, react_jsx_runtime.jsxs)("div", {
													className: Market_module_css_default.nm,
													children: [
														repoUrl !== null ? (0, react_jsx_runtime.jsx)("a", {
														...
														entry?.deprecated === true && (0, react_jsx_runtime.jsx)("span", {
															className: Market_module_css_default.depBadge,
															children: t("deprecatedBadge")
														}),
														version && (0, react_jsx_runtime.jsx)("span", {
															className: Market_module_css_default.owner,
															children: " " + version
														})
													]
												}),
												specRedundant ? null : repoUrl !== null ? (0, react_jsx_runtime.jsx)("a", {
												...
												entry !== void 0 && (0, react_jsx_runtime.jsx)("div", {
												...
												!off && act !== void 0 && meta !== null && (0, react_jsx_runtime.jsxs)("div", {
													className: Market_module_css_default.act,
													children: [meta.dot !== "done" && (0, react_jsx_runtime.jsxs)("span", {
														className: meta.dot === "error" ? Market_module_css_default.actBroken : Market_module_css_default.actWarn,
														children: [(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.StateDot, {
															state: meta.dot,
															size: 7
														}), meta.label]
													}), act.state !== "live" && act.reasons.length > 0 && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.DisclosureRow, {
														icon: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconQuestionOutline14, { size: 14 }),
														title: t("actWhy"),
														open: whyOpen === name,
														expandable: true,
												...
												entry !== void 0 && entry.deprecated === true && (0, react_jsx_runtime.jsx)("div", {
													className: Market_module_css_default.deprecate,
													style: { marginTop: 8 },
													children: (0, react_jsx_runtime.jsxs)("div", {
														className: Market_module_css_default.depLine,
														children: [(0, react_jsx_runtime.jsxs)("span", { children: ["⚠️ ", t("deprecatedWarn")] }), entry.replacement !== void 0 && (0, react_jsx_runtime.jsx)("span", {
															className: Market_module_css_default.src,
															children: t("replacementHint") + " " + entry.replacement
														})]
													})
												}),
												updatingName === name && (0, react_jsx_runtime.jsxs)("div", {
													className: Market_module_css_default.progress,
													children: [
														(0, react_jsx_runtime.jsx)("span", {
															className: Market_module_css_default.spin,
											...
											children: [
												!missing && (0, react_jsx_runtime.jsxs)("span", {
												...
												toggleable && (0, react_jsx_runtime.jsx)("button", {
													type: "button",
													role: "switch",
													"aria-checked": !off,
												...
												entry !== void 0 && entry.deprecated === true && entry.replacement !== void 0 && (() => {
													...
													return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
														variant: "outline",
														size: "sm",
														onClick: () => {
															setCat("all");
													...
													}), !isInstalled(replacement, installed, repoIdentities, data?.plugins, repoHints) && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
														variant: "outline",
														size: "sm",
												...
												(0, react_jsx_runtime.jsxs)("span", {
													...
													children: [missing ? (0, react_jsx_runtime.jsx)("span", {
														className: Market_module_css_default.metaTag,
														children: t("notInstalled")
													}) : updatedNames.includes(name) ? (0, react_jsx_runtime.jsx)("span", {
													...
													}) : updatingName === name ? (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
														variant: "primary",
														size: "sm",
														className: Market_module_css_default.warnBtn,
														disabled: true,
														children: t("updating")
													}) : status && status.updateAvailable ? (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
														variant: "primary",
														size: "sm",
														className: Market_module_css_default.warnBtn,
														...
														children: t("update")
													}) : status && status.kind === "linked" ? (0, react_jsx_runtime.jsx)("span", {
														className: Market_module_css_default.metaTag,
														title: t("linkedDev"),
														...
														title: t("upToDate"),
														children: t("upToDate")
													}), !missing && name !== "dsh-market" && name !== "dshmarket" && (removingName === name ? (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
														variant: "outline",
														size: "sm",
														className: Market_module_css_default.dangerBtn,
														disabled: true,
					...
					showTop && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
						label: t("backTop"),
						side: "top",
						children: (0, react_jsx_runtime.jsx)("span", {
							...
							children: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
								...
								children: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronUpOutline14, { size: 16 })
							})
						})
					}),
					confirming !== null && (0, react_jsx_runtime.jsxs)(_deepseek_ai_dsh_client_ui_primitives.Modal, {
						open: true,
						onClose: () => {
							setConfirming(null);
							setCmdOpen(false);
						...
						children: [
							(0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									typeof confirming.downloads === "number" && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
									...
									typeof confirming.stars === "number" && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
							...
							confirming.added && (0, react_jsx_runtime.jsx)("div", {
							...
							(0, react_jsx_runtime.jsx)(ScreenshotStrip, {
								plugin: confirming,
								onOpen: openLightbox
							}),
							(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.DisclosureRow, {
								icon: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconCodeOutline16, { size: 16 }),
								title: t("cmdDetails"),
								open: cmdOpen,
								expandable: true,
								expandOnRowClick: true,
							...
							looksTerminal(confirming, lang) && (0, react_jsx_runtime.jsxs)("p", {
								className: Market_module_css_default.warnLine,
								children: [
									(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconWarningOutline16, {
										size: 14,
					...
					lightbox !== null && (0, react_jsx_runtime.jsx)(ScreenshotLightbox, {
						shots: lightbox.shots,
						startIndex: lightbox.index,
						onClose: () => setLightbox(null),
						t
					}),
					removeConfirm !== null && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Modal, {
						open: true,
					...
					restoreConfirmOpen && pendingBackup !== null && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Modal, {
						open: true,
					...
					exportOpen && (0, react_jsx_runtime.jsxs)(_deepseek_ai_dsh_client_ui_primitives.Modal, {
						open: true,
						...
						children: [exportOptions.length === 0 && (0, react_jsx_runtime.jsx)("p", { children: t("gistNoPlugins") }), exportOptions.length > 0 && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
							(0, react_jsx_runtime.jsxs)("div", {
								className: Market_module_css_default.backupActions,
								children: [(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
									size: "sm",
							...
							(0, react_jsx_runtime.jsx)("div", {
								...
								children: exportOptions.map((name) => (0, react_jsx_runtime.jsxs)("label", {
									className: Market_module_css_default.backupCheck,
									children: [
										(0, react_jsx_runtime.jsx)("input", {
											type: "checkbox",
										...
										specKind(installed[name]) === "git" && (0, react_jsx_runtime.jsx)("span", {
											className: `${Market_module_css_default.specTag} ${Market_module_css_default.specTagGit}`,
											children: "git"
										}),
										specKind(installed[name]) === "file" && (0, react_jsx_runtime.jsx)("span", {
							...
							exportIncludeConfig && (0, react_jsx_runtime.jsx)("p", {
								className: Market_module_css_default.backupWarn,
								children: t("credsWarning")
							}),
							exportError !== null && (0, react_jsx_runtime.jsx)("p", {
								className: Market_module_css_default.backupWarn,
								children: exportError
							})
						] })]
					}),
					exportState === "done" && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Toast, {
						text: t("exportedLog"),
						icon: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconCheckOutline16, { size: 14 }),
						onDone: exportToastDone
					}),
					exportState === "fail" && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Toast, {
						text: t("exportLogFail"),
						icon: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconWarningOutline16, { size: 14 }),
						onDone: exportToastDone
					})
				]
			});
